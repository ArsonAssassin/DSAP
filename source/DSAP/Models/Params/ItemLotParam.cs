...
namespace DSAP.Models
{
    ...
    internal class ItemLotParam : IParam
    {
        ...
        override public string ToString()
        {
            ...
            result += $"{{\"id\":{lotItemId01}, \"cat\":{lotItemCategory01:X}, \"BasePoint\":{lotItemBasePoint01}, \"lotItemNum\":{lotItemNum01}, \"cumulateLotPoint\":{cumulateLotPoint01}, \"gifid\":{getItemFlagId01}}}, ";
            result += $"{{\"id\":{lotItemId02}, \"cat\":{lotItemCategory02:X}, \"BasePoint\":{lotItemBasePoint02}, \"lotItemNum\":{lotItemNum02}, \"cumulateLotPoint\":{cumulateLotPoint02}, \"gifid\":{getItemFlagId02}}}, ";
            result += $"{{\"id\":{lotItemId03}, \"cat\":{lotItemCategory03:X}, \"BasePoint\":{lotItemBasePoint03}, \"lotItemNum\":{lotItemNum03}, \"cumulateLotPoint\":{cumulateLotPoint03}, \"gifid\":{getItemFlagId03}}}, ";
            result += $"{{\"id\":{lotItemId04}, \"cat\":{lotItemCategory04:X}, \"BasePoint\":{lotItemBasePoint04}, \"lotItemNum\":{lotItemNum04}, \"cumulateLotPoint\":{cumulateLotPoint04}, \"gifid\":{getItemFlagId04}}}, ";
            result += $"{{\"id\":{lotItemId05}, \"cat\":{lotItemCategory05:X}, \"BasePoint\":{lotItemBasePoint05}, \"lotItemNum\":{lotItemNum05}, \"cumulateLotPoint\":{cumulateLotPoint05}, \"gifid\":{getItemFlagId05}}}, ";
            result += $"{{\"id\":{lotItemId06}, \"cat\":{lotItemCategory06:X}, \"BasePoint\":{lotItemBasePoint06}, \"lotItemNum\":{lotItemNum06}, \"cumulateLotPoint\":{cumulateLotPoint06}, \"gifid\":{getItemFlagId06}}}, ";
            result += $"{{\"id\":{lotItemId07}, \"cat\":{lotItemCategory07:X}, \"BasePoint\":{lotItemBasePoint07}, \"lotItemNum\":{lotItemNum07}, \"cumulateLotPoint\":{cumulateLotPoint07}, \"gifid\":{getItemFlagId07}}}, ";
            result += $"{{\"id\":{lotItemId08}, \"cat\":{lotItemCategory08:X}, \"BasePoint\":{lotItemBasePoint08}, \"lotItemNum\":{lotItemNum08}, \"cumulateLotPoint\":{cumulateLotPoint08}, \"gifid\":{getItemFlagId08}}}";
            result += $"]}}";
            return result;
        }
        public string ToString(List<DarkSoulsItem> allitems)
        {
            ...
            if (lotItemId01 > 0)
            {
                ...
                result += $"{{\"name\":\"{itemname}\", \"id\":{lotItemId01}, \"cat\":{lotItemCategory01:X}, \"lotItemNum\":{lotItemNum01}, \"BasePoint\":{lotItemBasePoint01}, \"cumulateLotPoint\":{cumulateLotPoint01}, \"gifid\":{getItemFlagId01}}}, ";
            }
            if (lotItemId02 > 0)
            {
                string itemname = allitems.Find(x => x.Id == lotItemId02 && (int)x.Category == lotItemCategory02)?.Name ?? "unknown";
                result += $"{{\"name\":\"{itemname}\", \"id\":{lotItemId02}, \"cat\":{lotItemCategory02:X}, \"lotItemNum\":{lotItemNum02}, \"BasePoint\":{lotItemBasePoint02}, \"cumulateLotPoint\":{cumulateLotPoint02}, \"gifid\":{getItemFlagId02}}}, ";
            }
            if (lotItemId03 > 0)
            {
                string itemname = allitems.Find(x => x.Id == lotItemId03 && (int)x.Category == lotItemCategory03)?.Name ?? "unknown";
                result += $"{{\"name\":\"{itemname}\", \"id\":{lotItemId03}, \"cat\":{lotItemCategory03:X}, \"lotItemNum\":{lotItemNum03}, \"BasePoint\":{lotItemBasePoint03}, \"cumulateLotPoint\":{cumulateLotPoint03}, \"gifid\":{getItemFlagId03}}}, ";
            }
            if (lotItemId04 > 0)
            {
                string itemname = allitems.Find(x => x.Id == lotItemId04 && (int)x.Category == lotItemCategory04)?.Name ?? "unknown";
                result += $"{{\"name\":\"{itemname}\", \"id\":{lotItemId04}, \"cat\":{lotItemCategory04:X}, \"lotItemNum\":{lotItemNum04}, \"BasePoint\":{lotItemBasePoint04}, \"cumulateLotPoint\":{cumulateLotPoint04}, \"gifid\":{getItemFlagId04}}}, ";
            }
            if (lotItemId05 > 0)
            {
                string itemname = allitems.Find(x => x.Id == lotItemId05 && (int)x.Category == lotItemCategory05)?.Name ?? "unknown";
                result += $"{{\"name\":\"{itemname}\", \"id\":{lotItemId05}, \"cat\":{lotItemCategory05:X}, \"lotItemNum\":{lotItemNum05}, \"BasePoint\":{lotItemBasePoint05}, \"cumulateLotPoint\":{cumulateLotPoint05}, \"gifid\":{getItemFlagId05}}}, ";
            }
            if (lotItemId06 > 0)
            {
                string itemname = allitems.Find(x => x.Id == lotItemId06 && (int)x.Category == lotItemCategory06)?.Name ?? "unknown";
                result += $"{{\"name\":\"{itemname}\", \"id\":{lotItemId06}, \"cat\":{lotItemCategory06:X}, \"lotItemNum\":{lotItemNum06}, \"BasePoint\":{lotItemBasePoint06}, \"cumulateLotPoint\":{cumulateLotPoint06}, \"gifid\":{getItemFlagId06}}}, ";
            }
            if (lotItemId07 > 0)
            {
                string itemname = allitems.Find(x => x.Id == lotItemId07 && (int)x.Category == lotItemCategory07)?.Name ?? "unknown";
                result += $"{{\"name\":\"{itemname}\", \"id\":{lotItemId07}, \"cat\":{lotItemCategory07:X}, \"lotItemNum\":{lotItemNum07}, \"BasePoint\":{lotItemBasePoint07}, \"cumulateLotPoint\":{cumulateLotPoint07}, \"gifid\":{getItemFlagId07}}}, ";
            }
            if (lotItemId08 > 0)
            {
                string itemname = allitems.Find(x => x.Id == lotItemId08 && (int)x.Category == lotItemCategory08)?.Name ?? "unknown";
                result += $"{{\"name\":\"{itemname}\", \"id\":{lotItemId08}, \"cat\":{lotItemCategory08:X}, \"lotItemNum\":{lotItemNum08}, \"BasePoint\":{lotItemBasePoint08}, \"cumulateLotPoint\":{cumulateLotPoint08}, \"gifid\":{getItemFlagId08}}}, ";
            }
            result += $"]}}";
            return result;
        }
