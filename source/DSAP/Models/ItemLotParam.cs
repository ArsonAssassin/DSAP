...
namespace DSAP.Models
{
    ...
    internal class ItemLotParam
    {
        ...
        {
            string result = $"{{ItemLotParam {getItemFlagId}, cnflid = {cumulateNumFlagId}, cnm = {cumulateNumMax}, items= [";
            result += $"{{id={lotItemId01}, cat={lotItemCategory01}, bp={lotItemBasePoint01}, clp={cumulateLotPoint01}, gifid={getItemFlagId01}}}, ";
            result += $"{{id={lotItemId02}, cat={lotItemCategory02}, bp={lotItemBasePoint02}, clp={cumulateLotPoint02}, gifid={getItemFlagId02}}}, ";
            result += $"{{id={lotItemId03}, cat={lotItemCategory03}, bp={lotItemBasePoint03}, clp={cumulateLotPoint03}, gifid={getItemFlagId03}}}, ";
            result += $"{{id={lotItemId04}, cat={lotItemCategory04}, bp={lotItemBasePoint04}, clp={cumulateLotPoint04}, gifid={getItemFlagId04}}}, ";
            result += $"{{id={lotItemId05}, cat={lotItemCategory05}, bp={lotItemBasePoint05}, clp={cumulateLotPoint05}, gifid={getItemFlagId05}}}, ";
            result += $"{{id={lotItemId06}, cat={lotItemCategory06}, bp={lotItemBasePoint06}, clp={cumulateLotPoint06}, gifid={getItemFlagId06}}}, ";
            result += $"{{id={lotItemId07}, cat={lotItemCategory07}, bp={lotItemBasePoint07}, clp={cumulateLotPoint07}, gifid={getItemFlagId07}}}, ";
            result += $"{{id={lotItemId08}, cat={lotItemCategory08}, bp={lotItemBasePoint08}, clp={cumulateLotPoint08}, gifid={getItemFlagId08}}}";
            result += "]" ;
            return result;
        }
    }
