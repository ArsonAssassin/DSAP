...
_all_items = [DSRItemData(row[0], row[1], row[2]) for row in [    
    ...
    ("Prism Stone", 2-23, DSRItemCategory.CONSUMABLE),
    ...
    ("Guardian Soul", 260, DSRItemCategory.CONSUMABLE),
    ("Soul of Artorias", 2061, DSRItemCategory.CONSUMABLE),
    ("White Soapstone", 2062, DSRItemCategory.CONSUMABLE),
    ("Red Sign Soapstone", 2063, DSRItemCategory.CONSUMABLE),
    ("Red Eye Orb", 2064, DSRItemCategory.CONSUMABLE),
    ("Black Separation Crystal", 2065, DSRItemCategory.CONSUMABLE),
    ("Orange Guidance Soapstone", 2066, DSRItemCategory.CONSUMABLE),
    ("Book of the Guilty", 2067, DSRItemCategory.CONSUMABLE),
    ("Servant Roster", 2068, DSRItemCategory.CONSUMABLE),
    ("Blue Eye Orb", 2069, DSRItemCategory.CONSUMABLE),
    ("Dragon Eye", 2070, DSRItemCategory.CONSUMABLE),
    ("Black Eye Orb", 2071, DSRItemCategory.CONSUMABLE),
    ("Darksign", 2072, DSRItemCategory.CONSUMABLE), # not sure if we want to randomize this one or not
    ("Purple Coward's Crystal", 2073, DSRItemCategory.CONSUMABLE),
    ("Silver Pendant", 2074, DSRItemCategory.CONSUMABLE),
    ("Dried Finger", 2075, DSRItemCategory.CONSUMABLE),
    ("Carving: HELLO!", 2076, DSRItemCategory.CONSUMABLE),
    ("Carving: THANK YOU!", 2077, DSRItemCategory.CONSUMABLE),
    ("Carving: VERY GOOD!", 2078, DSRItemCategory.CONSUMABLE),
    ("Carving: I'M SORRY!", 2079, DSRItemCategory.CONSUMABLE),
    ("Carving: HELP ME!", 2080, DSRItemCategory.CONSUMABLE),
    ...
    ("Parrying Dagger", 8000, DSRItemCategory.WEAPON)
    ("Ghost Blade", 8000, DSRItemCategory.WEAPON)
    ("Bandit's Knife", 8000, DSRItemCategory.WEAPON)
    ("Priscilla's Dagger", 8000, DSRItemCategory.WEAPON)
    ("Shortsword", 8000, DSRItemCategory.WEAPON)
    ("Longsword", 8000, DSRItemCategory.WEAPON)
    ("BroadSword", 8000, DSRItemCategory.WEAPON)
    ("Broken Straight Sword", 8000, DSRItemCategory.WEAPON)
    ("Balder Side Sword", 8000, DSRItemCategory.WEAPON)
    ("Straight Sword", 8000, DSRItemCategory.WEAPON)
    ("Barbed Straight Sword", 8000, DSRItemCategory.WEAPON)
    ("Silver Knight Straight Sword", 8000, DSRItemCategory.WEAPON)
    ("Astora's Straight Sword", 8000, DSRItemCategory.WEAPON)
    ("Darksword", 8000, DSRItemCategory.WEAPON)
    ("Drake Sword", 8000, DSRItemCategory.WEAPON)
    ("Straight Sword Hilt", 8000, DSRItemCategory.WEAPON)
    ("Bastard Sword", 8000, DSRItemCategory.WEAPON)
    ("Claymore", 8000, DSRItemCategory.WEAPON)
    ("Man-Serpent Greatsword", 8000, DSRItemCategory.WEAPON)
    ("Flamberge", 8000, DSRItemCategory.WEAPON)
    ("Crystal Greatsword", 8000, DSRItemCategory.WEAPON)
    ("Stone Greatsword", 8000, DSRItemCategory.WEAPON)
    ("Greatsword of Artorias", 8000, DSRItemCategory.WEAPON)
    ("Moonlight Greatsword", 8000, DSRItemCategory.WEAPON)
    ("Black Knight Sword", 8000, DSRItemCategory.WEAPON)
    ("Great Lord Greatsword", 8000, DSRItemCategory.WEAPON)
    ("Zweihander", 8000, DSRItemCategory.WEAPON)
    ("Greatsword", 8000, DSRItemCategory.WEAPON)
    ("Demon Great Machete", 8000, DSRItemCategory.WEAPON)
    ("Dragon Greatsword", 8000, DSRItemCategory.WEAPON)
    ("Black Knight Greatsword", 8000, DSRItemCategory.WEAPON)
    ("Scimitar", 8000, DSRItemCategory.WEAPON)
    ("Falchion", 8000, DSRItemCategory.WEAPON)
    ("Shotel", 8000, DSRItemCategory.WEAPON)
    ("Jagged Ghost Blade", 8000, DSRItemCategory.WEAPON)
    ("Painting Guardian Sword", 8000, DSRItemCategory.WEAPON)
    ("Quelaag's Furysword", 8000, DSRItemCategory.WEAPON)
    ("Server", 8000, DSRItemCategory.WEAPON)
    ("Murakumo", 8000, DSRItemCategory.WEAPON)
    ("Gravelord Sword", 8000, DSRItemCategory.WEAPON)
    ("Uchigatana", 8000, DSRItemCategory.WEAPON)
    ("Washing Pole", 8000, DSRItemCategory.WEAPON)
    ("Iaito", 8000, DSRItemCategory.WEAPON)
    ("Chaos Blade", 8000, DSRItemCategory.WEAPON)
    ("Mail Breaker", 8000, DSRItemCategory.WEAPON)
    ("Rapier", 8000, DSRItemCategory.WEAPON)
    ("Estoc", 8000, DSRItemCategory.WEAPON)
    ("Velka's Rapier", 8000, DSRItemCategory.WEAPON)
    ("Ricard's Rapier", 8000, DSRItemCategory.WEAPON)
    ("Hand Axe", 8000, DSRItemCategory.WEAPON)
    ("Battle Axe", 8000, DSRItemCategory.WEAPON)
    ("Crescent Axe", 8000, DSRItemCategory.WEAPON)
    ("Butcher Knife", 8000, DSRItemCategory.WEAPON)
    ("Golem Axe", 8000, DSRItemCategory.WEAPON)
    ("Gargoyle Tail Axe", 8000, DSRItemCategory.WEAPON)
    ("Greataxe", 8000, DSRItemCategory.WEAPON)
    ("Demon's Greataxe", 8000, DSRItemCategory.WEAPON)
    ("Club", 8000, DSRItemCategory.WEAPON)
    ("Mace", 8000, DSRItemCategory.WEAPON)
    ("Morning Star", 8000, DSRItemCategory.WEAPON)
    ("Warpick", 8000, DSRItemCategory.WEAPON)
    ("Pickaxe", 8000, DSRItemCategory.WEAPON)
    ("Reinforced Club", 8000, DSRItemCategory.WEAPON)
    ("Blacksmith Hammer", 8000, DSRItemCategory.WEAPON)
    ("Hammer of Vamos", 8000, DSRItemCategory.WEAPON)
    ("Great Club", 8000, DSRItemCategory.WEAPON)
    ("Grant", 8000, DSRItemCategory.WEAPON)
    ("Demon's Great Hammer", 8000, DSRItemCategory.WEAPON)
    ("Dragon Tooth", 8000, DSRItemCategory.WEAPON)
    ("Large Club", 8000, DSRItemCategory.WEAPON)
    ("Smough's Hammer", 8000, DSRItemCategory.WEAPON)
    ("Caestus", 8000, DSRItemCategory.WEAPON)
    ("Claw", 8000, DSRItemCategory.WEAPON)
    ("Dragon Bone Fist", 8000, DSRItemCategory.WEAPON)
    ("Dark Hand", 8000, DSRItemCategory.WEAPON)
    ("Spear", 8000, DSRItemCategory.WEAPON)
    ("Winged Spear", 8000, DSRItemCategory.WEAPON)
    ("Partizan", 8000, DSRItemCategory.WEAPON)
    ("Demon's Spear", 8000, DSRItemCategory.WEAPON)
    ("Channeler's Trident", 8000, DSRItemCategory.WEAPON)
    ("Silver Knight Spear", 8000, DSRItemCategory.WEAPON)
    ("Pike", 8000, DSRItemCategory.WEAPON)
    ("Dragonslayer Spear", 8000, DSRItemCategory.WEAPON)
    ("Moonlight Butterfly Horn", 8000, DSRItemCategory.WEAPON)
    ("Halberd", 8000, DSRItemCategory.WEAPON)
    ("Giant's Halberd", 8000, DSRItemCategory.WEAPON)
    ("Titanite Catch Pole", 8000, DSRItemCategory.WEAPON)
    ("Gargoyles's Halberd", 8000, DSRItemCategory.WEAPON)
    ("Black Knight Halberd", 8000, DSRItemCategory.WEAPON)
    ("Lucerne", 8000, DSRItemCategory.WEAPON)
    ("Scythe", 8000, DSRItemCategory.WEAPON)
    ("Great Scythe", 8000, DSRItemCategory.WEAPON)
    ("Lifehunt Scythe", 8000, DSRItemCategory.WEAPON)
    ("Whip", 8000, DSRItemCategory.WEAPON)
    ("Notched Whip", 8000, DSRItemCategory.WEAPON)

    ("Short Bow", 8000, DSRItemCategory.WEAPON) # ranged weapons
    ("Longbow", 8000, DSRItemCategory.WEAPON)
    ("Black Bow of Pharis", 8000, DSRItemCategory.WEAPON)
    ("Dragonslayer Greatbow", 8000, DSRItemCategory.WEAPON)
    ("Composite Bow", 8000, DSRItemCategory.WEAPON)
    ("Darkmoon Bow", 8000, DSRItemCategory.WEAPON)
    ("Light Crossbow", 8000, DSRItemCategory.WEAPON)
    ("Heavy Crossbow", 8000, DSRItemCategory.WEAPON)
    ("Avelyn", 8000, DSRItemCategory.WEAPON)
    ("Sniper Crossbow", 8000, DSRItemCategory.WEAPON)

    ("Sorcerer's Catalyst", 8000, DSRItemCategory.WEAPON) # magic weapons
    ("Beatrice's Catalyst", 8000, DSRItemCategory.WEAPON)
    ("Tin Banishment Catalyst", 8000, DSRItemCategory.WEAPON)
    ("Logan's Catalyst", 8000, DSRItemCategory.WEAPON)
    ("Tin Darkmoon Catalyst", 8000, DSRItemCategory.WEAPON)
    ("Oolacile Ivory Catalyst", 8000, DSRItemCategory.WEAPON)
    ("Tin Crystallization Catalyst", 8000, DSRItemCategory.WEAPON)
    ("Demon's Catalyst", 8000, DSRItemCategory.WEAPON)
    ("Izalith Catalyst", 8000, DSRItemCategory.WEAPON)
    ("Pyromancy Flame", 8000, DSRItemCategory.WEAPON)
    ("Talisman", 8000, DSRItemCategory.WEAPON)
    ("Canvas Talisman", 8000, DSRItemCategory.WEAPON)
    ("Thorolund Talisman", 8000, DSRItemCategory.WEAPON)
    ("Ivory Talisman", 8000, DSRItemCategory.WEAPON)
    ("Sunlight Talisman", 8000, DSRItemCategory.WEAPON)
    ("Darkmoon Talisman", 8000, DSRItemCategory.WEAPON)
    ("Velka's Talisman", 8000, DSRItemCategory.WEAPON)

    ("Skull Lantern", 9000, DSRItemCategory.SHIELD)
    ("East-West Shield", 9000, DSRItemCategory.SHIELD)
    ("Wooden Shield", 9000, DSRItemCategory.SHIELD)
    ("Large Leather Shield", 9000, DSRItemCategory.SHIELD)
    ("Small Leather Shield", 9000, DSRItemCategory.SHIELD)
    ("Target Shield", 9000, DSRItemCategory.SHIELD)
    ("Buckler", 9000, DSRItemCategory.SHIELD)
    ("Cracked Round Shield", 9000, DSRItemCategory.SHIELD)
    ("Leather Shield", 9000, DSRItemCategory.SHIELD)
    ("Plank Shield", 9000, DSRItemCategory.SHIELD)
    ("Caduceus Round Shield", 9000, DSRItemCategory.SHIELD)
    ("Crystal Ring Shield", 9000, DSRItemCategory.SHIELD)
    ("Heater Shield", 9000, DSRItemCategory.SHIELD)
    ("Knight Shield", 9000, DSRItemCategory.SHIELD)
    ("Tower Kite Shield", 9000, DSRItemCategory.SHIELD)
    ("Grass Crest Shield", 9000, DSRItemCategory.SHIELD)
    ("Hollow Soldier Shield", 9000, DSRItemCategory.SHIELD)
    ("Balder Shield", 9000, DSRItemCategory.SHIELD)
    ("Crest Shield", 9000, DSRItemCategory.SHIELD)
    ("Dragon Crest Shield", 9000, DSRItemCategory.SHIELD)
    ("Warrior's Round Shield", 9000, DSRItemCategory.SHIELD)
    ("Iron Round Shield", 9000, DSRItemCategory.SHIELD)
    ("Spider Shield", 9000, DSRItemCategory.SHIELD)
    ("Spiked Shield", 9000, DSRItemCategory.SHIELD)
    ("Crystal Shield", 9000, DSRItemCategory.SHIELD)
    ("Sunlight Shield", 9000, DSRItemCategory.SHIELD)
    ("Silver Knight Shield", 9000, DSRItemCategory.SHIELD)
    ("Black Knight Shield", 9000, DSRItemCategory.SHIELD)
    ("Pierce Shield", 9000, DSRItemCategory.SHIELD)
    ("Red and White Round Shield", 9000, DSRItemCategory.SHIELD)
    ("Caduceus Kite Shield", 9000, DSRItemCategory.SHIELD)
    ("Gargoyle's Shield", 9000, DSRItemCategory.SHIELD)
    ("Eagle Shield", 9000, DSRItemCategory.SHIELD)
    ("Tower Shield", 9000, DSRItemCategory.SHIELD)
    ("Giant Shield", 9000, DSRItemCategory.SHIELD)
    ("Stone Greatshield", 9000, DSRItemCategory.SHIELD)
    ("Havel's Greatshield", 9000, DSRItemCategory.SHIELD)
    ("Bonewheel Shield", 9000, DSRItemCategory.SHIELD)
    ("Greatshield of Artorias", 9000, DSRItemCategory.SHIELD)
    ("Effigy Shield", 9000, DSRItemCategory.SHIELD)
    ("Sanctus", 9000, DSRItemCategory.SHIELD)
    ("Bloodshield", 9000, DSRItemCategory.SHIELD)
    ("Black Iron Greatshield", 9000, DSRItemCategory.SHIELD)
]]
