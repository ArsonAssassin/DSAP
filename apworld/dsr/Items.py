...
_all_items = [DSRItemData(row[0], row[1], row[2]) for row in [    
    ...
    ("Asylum Demon Defeated", 0, DSRItemCategory.EVENT),
    ("Tauros Demon Defeated", 1, DSRItemCategory.EVENT),
    ("Bell Gargoyles Defeated", 2, DSRItemCategory.EVENT),
    ("Capra Demon Defeated", 3, DSRItemCategory.EVENT),
    ("Ceaseless Discharge Defeated", 4, DSRItemCategory.EVENT),
    ("Centipede Demon Defeated", 5, DSRItemCategory.EVENT),
    ("Chaos Witch Quelaag Defeated", 6, DSRItemCategory.EVENT),
    ("Crossbreed Priscilla Defeated", 7, DSRItemCategory.EVENT),
    ("Demon Firesage Defeated", 8, DSRItemCategory.EVENT),
    ("Ornstein and Smough Defeated", 9, DSRItemCategory.EVENT),
    ("Four Kings Defeated", 10, DSRItemCategory.EVENT),
    ("Gaping Dragon Defeated", 11, DSRItemCategory.EVENT),
    ("Gravelord Nito Defeated", 12, DSRItemCategory.EVENT),
    ("Great Grey Wolf Sif Defeated", 13, DSRItemCategory.EVENT),
    ("Gwyn, Lord of Cinder Defeated", 14, DSRItemCategory.EVENT),
    ("Iron Golem Defeated", 15, DSRItemCategory.EVENT),
    ("Moonlight Butterfly Defeated", 16, DSRItemCategory.EVENT),
    ("Pinwheel Defeated", 17, DSRItemCategory.EVENT),
    ("Seath the Scaleless Defeated", 18, DSRItemCategory.EVENT),
    ("Black Dragon Kalameet Defeated", 19, DSRItemCategory.EVENT),
    ("Bed of Chaos Defeated", 20, DSRItemCategory.EVENT),
    ("Manus, Father of the Abyss Defeated", 21, DSRItemCategory.EVENT),
    ("Knight Artorias Defeated", 22, DSRItemCategory.EVENT),    
