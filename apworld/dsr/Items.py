...
_all_items = [DSRItemData(row[0], row[1], row[2]) for row in [    
    ...
    ("Stray Demon", 1025, DSRItemCategory.EVENT),
    ...
    ("Helm of Artorias", 7133, DSRItemCategory.ARMOR),
    ("Armor of Artorias", 7134, DSRItemCategory.ARMOR),
    ("Gauntlets of Artorias", 7135, DSRItemCategory.ARMOR),
    ("Leggings of Artorias", 7136, DSRItemCategory.ARMOR),
    ("Porcelain Mask", 7137, DSRItemCategory.ARMOR),
    ("Lord's Blade Robe", 7215, DSRItemCategory.ARMOR),
    ("Lord's Blade Gloves", 7216, DSRItemCategory.ARMOR),
    ("Lord's Blade Waistcloth", 7217, DSRItemCategory.ARMOR),
    ("Gough's Helm", 7218, DSRItemCategory.ARMOR),
    ("Gough's Armor", 7219, DSRItemCategory.ARMOR),
    ("Gough's Gauntlets", 7220, DSRItemCategory.ARMOR),
    ("Gough's Leggings", 7221, DSRItemCategory.ARMOR),
    ("Guardian Helm", 7222, DSRItemCategory.ARMOR),
    ("Guardian Armor", 7223, DSRItemCategory.ARMOR),
    ("Guardian Gauntlets", 7224, DSRItemCategory.ARMOR),
    ("Guardian Leggings", 7225, DSRItemCategory.ARMOR),
    ("Snickering Top Hat", 7226, DSRItemCategory.ARMOR),
    ("Chester's Long Coat", 7227, DSRItemCategory.ARMOR),
    ("Chester's Gloves", 7228, DSRItemCategory.ARMOR),
    ("Shester's Trousers", 7229, DSRItemCategory.ARMOR),
    ("Bloated Head", 7230, DSRItemCategory.ARMOR),
    ("Bloated Sorcerer Head", 7231, DSRItemCategory.ARMOR),
