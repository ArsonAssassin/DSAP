...
"Upper Undead Burg": [
    ...
    DSRLocationData(11110044, f"UB: Light Crossbow and Standard Bolts", f"Firebomb", DSRLocationCategory.ITEM_LOT),
...
"Lower Undead Burg": [
    ...
    DSRLocationData(11110565, f"UB: Thief Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
...
"Lower Undead Burg - After Residence Key": [
    DSRLocationData(11110110, f"UB: Sorcerer Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
...
"Depths": [
    ...
    DSRLocationData(11110125, f"DE: Heavy Crossbow and Heavy Bolts", f"Firebomb", DSRLocationCategory.ITEM_LOT),
...
"Blighttown": [
    ...
    DSRLocationData(11110141, f"BT: Shadow Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    ...
    DSRLocationData(11110146, f"BT: Wanderer Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    ...
    DSRLocationData(11110150, f"BT: Butcher Knife", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110151, f"BT: Humanity - Maneater Mildred", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    ...
    DSRLocationData(11110155, f"BT: Pyromancer Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
...
"Valley of the Drakes": [
    ...
    DSRLocationData(11110179, f"VotD: Brigand Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
...
"Valley of the Drakes - After Defeating Four Kings": [
    DSRLocationData(11110182, f"VotD: Witch Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
...
"Darkroot Basin": [
    ...
    DSRLocationData(11110190, f"DB: Knight Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110191, f"DB: Dusk Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Darkroot Garden": [
    ...
    DSRLocationData(11110196, f"DG: Elite Knight Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
...
"Darkroot Garden - Behind Artorias Door": [
    DSRLocationData(11110553, f"DG: Eastern Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110204, f"DG: Stone Knight Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110578, f"DG: Large Soul of a Brave Warrior - Darkroot Garden Cats", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110205, f"DG: Shiva Loot", f"Firebomb", DSRLocationCategory.ENEMY_DROP), 
    DSRLocationData(11110206, f"DG: Humanity - Shiva", f"Firebomb", DSRLocationCategory.ENEMY_DROP),
    DSRLocationData(11110207, f"DG: Pharis Loot", f"Firebomb", DSRLocationCategory.ENEMY_DROP),
...
"Sen's Fortress": [
    ...
    DSRLocationData(11110247, f"SF: Black Sorcerer Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    ...
    DSRLocationData(11110256, f"SF: Sniper Crossbow and Sniper Bolts", f"Firebomb", DSRLocationCategory.ITEM_LOT),
...
"Anor Londo": [
    ...
    DSRLocationData(11110270, f"AL: Black Iron Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    ...
    DSRLocationData(11110276, f"AL: Havel's Set 1", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110616, f"AL: Havel's Set 2", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    ...
    DSRLocationData(11110285, f"AL: Silver Knight Set 1", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110286, f"AL: Silver Knight Set 2", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    ...
    DSRLocationData(11110297, f"AL: Brass Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
...
"Painted World of Ariamis": [
    ...
    DSRLocationData(11110319, f"PW: Notched Whip", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110320, f"PW: Soul of a Brave Warrior - Painted World Bonewheels", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110321, f"PW: Pyromancy: Fire Surge", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    ...
    DSRLocationData(11110326, f"PW: Soul of Priscilla", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110327, f"PW: Xanthous Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Painted World of Ariamis - After Annex Key": [
    ...
    DSRLocationData(11110329, f"PW: Velka's Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
...
"Upper New Londo Ruins": [
    ...
    DSRLocationData(11110347, f"NL: Composite Bow and Large Arrows", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"New Londo Ruins Door to the Seal": [
...
"The Duke's Archives - After Archive Prison Extra Key": [    
    ...
    DSRLocationData(11110372, f"DA: Maiden Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
...
"The Duke's Archives - After Archive Tower Giant Door Key": [    
    ...
    DSRLocationData(11110388, f"DA: Channeler Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110389, f"DA: Prism Stone - Duke's Archives", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110390, f"DA: Crystalline Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
...
"Demon Ruins": [
    ...
    DSRLocationData(11110406, f"DR: Gold-Hemmed Black Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
...
"Lost Izalith": [
    DSRLocationData(11110411, f"LI: Thorns Set", f"Firebomb", DSRLocationCategory.ENEMY_DROP),
...
"The Catacombs - After Door 1": [  
    ...
    DSRLocationData(11110469, f"TC: Holy Set", f"Firebomb", DSRLocationCategory.ENEMY_DROP),
    DSRLocationData(11110552, f"TC: Mace", f"Firebomb", DSRLocationCategory.ENEMY_DROP),
...
"Tomb of the Giants": [
    ...
    DSRLocationData(11110486, f"TotG: Soul of a Brave Warrior - Lower Tomb of the Giants", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    ...
    DSRLocationData(11110489, f"TotG: Humanity - Paladin Leeroy", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],                    
"Tomb of the Giants - Behind Golden Fog Wall": [
    ...
    DSRLocationData(11110497, f"TotG: Paladin Set", f"Firebomb", DSRLocationCategory.ENEMY_DROP),
],
"Kiln of the First Flame": [ 
    DSRLocationData(11110498, f"KoFF: Black Knight Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
