...
"Firelink Shrine": [
    ...
    DSRLocationData(11110031, f"Soul of a Lost Undead - End of the Ledge", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110032, f"Soul of a Lost Undead - Behind Sewer Rat", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],  
"Upper Undead Burg": [
    ...
    DSRLocationData(11110046, f"Gold Pine Resin - 3x Gold Pine Resin in Chest behind Residence Key Door", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    ...
    DSRLocationData(11110051, f"Undead Burg Watchtower Upper opened", f"Firebomb", DSRLocationCategory.DOOR),
    DSRLocationData(11110052, f"Undead Burg Watchtower Lower opened", f"Firebomb", DSRLocationCategory.DOOR),
...
"Lower Undead Burg": [
    ...
    DSRLocationData(11110102, f"Sorcerer Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110103, f"Sorcerer's Catalyst", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110104, f"Twin Humanities - Corpse to the Right of Torch Hollows", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110105, f"Mail Breaker", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110106, f"Large Soul of a Lost Undead - Corpse in Barrel of Arched Corridor", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110107, f"Large Soul of a Lost Undead - Corpse Near Large Gate", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110108, f"Undead Burg Female Merchant Shortcut opened", f"Firebomb", DSRLocationCategory.DOOR),
    DSRLocationData(11110109, f"Capra Demon Defeated", f"Firebomb", DSRLocationCategory.BOSS),
    DSRLocationData(11110110, f"Key to Depths", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Depths": [
    ...
    DSRLocationData(11110117, f"Depths Bonfire Room opened", f"Firebomb", DSRLocationCategory.DOOR),
    DSRLocationData(11110118, f"Depths lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110119, f"Soul of a Nameless Soldier - Corpse near Drain Hole", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110120, f"Soul of a Nameless Soldier - Corpse near Giant Rat", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110121, f"Large Titanite Shard - Corpse behind Pillar", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110122, f"Large Soul of a Nameless Soldier - Corpse under Stairs with Basilisks", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110123, f"Soul of a Nameless Soldier - Corpse in Passage with Basilisks", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110124, f"Ring of the Evil Eye", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110125, f"Humanity - Corpse behind Hole", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110126, f"Heavy Crossbow and Heavy Bolts", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110127, f"Depths Shortcut opened", f"Firebomb", DSRLocationCategory.DOOR),
...
"Blighttown": [
    ...
    DSRLocationData(11110166, f"Purple Moss Clump - Lower Level near Blowdart Snipers", f"Firebomb", DSRLocationCategory.ITEM_LOT),
...
"Valley of the Drakes": [
    DSRLocationData(11110172, f"New Londo Ruins -> Valley of the Drakes", f"Firebomb", DSRLocationCategory.DOOR),
...
"Sen's Fortress": [
    DSRLocationData(11110232, f"Sen's Fortress Main Gate opened", f"Firebomb", DSRLocationCategory.DOOR),
...
"Painted World of Ariamis": [
    ...
    DSRLocationData(11110322, f"Dried Finger", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110323, f"Miracle: Vow of Silence", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110324, f"Velka's Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110325, f"Gold Coin - Hidden behind Barrels across Gap", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110326, f"Large Titanite Shard", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110327, f"Crossbreed Priscilla Defeated", f"Firebomb", DSRLocationCategory.BOSS),
    DSRLocationData(11110328, f"Soul of Priscilla", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110329, f"Xanthous Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Upper New Londo Ruins": [
    DSRLocationData(11110330, f"New Londo Ruins -> Valley of the Drakes", f"Firebomb", DSRLocationCategory.DOOR),
...
"The Duke's Archives": [
    ...
    DSRLocationData(11110367, f"Archive Tower Cell Key", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110368, f"Archive Prison Extra Key", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110369, f"Large Soul of a Proud Knight - In Reah's Cell", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110370, f"Maiden Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110371, f"White Seance Ring", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110372, f"Large Soul of a Brave Warrior - In Cell with Crystal Soldier", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110373, f"Soul of a Brave Warrior - Drop down from the right Side of Ledge", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110374, f"Archive Tower Giant Door Key", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110375, f"Miracle: Soothing Sunlight", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110376, f"Miracle: Bountiful Sunlight", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110377, f"Avelyn", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110378, f"Twinkling Titanite - In Chest near Stairway", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110379, f"Sorcery: Strong Magic Shield", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110380, f"Duke's Archives - Balcony lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110381, f"Duke's Archives Bookshelf Door opened", f"Firebomb", DSRLocationCategory.DOOR),
    DSRLocationData(11110382, f"Blue Titanite Chunk - In Chest near Secret Library", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110383, f"Enchanted Falcion", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110384, f"Archive Tower Giant Cell Key", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110385, f"Crystal Ember", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110386, f"Channeler Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110387, f"Fire Keeper Soul - Door at the Back of Pisacas Cell", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110388, f"Prism Stone - In Chest down the Stairs of Secret Library", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110389, f"Crystalline Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110390, f"Blue Titanite Chunk - Right Side of Inner Garden", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Crystal Cave": [
    DSRLocationData(11110391, f"Humanity - Corpse after first invisible Path", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110392, f"Blue Titanite Chunk - Corpse next to Golem", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110393, f"Twinkling Titanite - Drop from first Crystal Lizard", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110394, f"Twinkling Titanite - Drop from second Crystal Lizard", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110395, f"Twinkling Titanite - Drop from third Crystal Lizard", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110396, f"Blue Titanite Slab - On Crystal Beam", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110397, f"Soul of a Hero - Left of Cave", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110398, f"Seath the Scaleless Defeated", f"Firebomb", DSRLocationCategory.BOSS),
    DSRLocationData(11110399, f"Bequeathed Lord Soul Shard", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110400, f"Crystal Cave lit", f"Firebomb", DSRLocationCategory.BONFIRE),
],
"Duke's Archives - First Arena after Seath's Death": [
    DSRLocationData(11110401, f"Large Magic Ember", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110402, f"Soul of a Great Hero - Near Large Magic Ember", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Demon Ruins": [
    DSRLocationData(11110403, f"Demon Ruins - Entrance lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110404, f"Gold-Hemmed Black Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110405, f"Ceaseless Discharge Defeated", f"Firebomb", DSRLocationCategory.BOSS),
    DSRLocationData(11110406, f"Large Soul of a Proud Knight - First Jump over the Lava", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110407, f"Chaos Flame Ember", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110408, f"Soul of a Proud Knight - Corpse found while Ascending the Path", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110409, f"Thorns Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110410, f"Demon Ruins - Staircase lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110411, f"Green Titanite Shard - 2x Green Titanite Shards under the Staircase", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110412, f"Soul of a Proud Knight - Near Bonfire", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110413, f"Large Flame Ember", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110414, f"Soul of a Brave Warrior - Path to the Right before Fog Gate", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110415, f"Demon Firesage Defeated", f"Firebomb", DSRLocationCategory.BOSS),
    DSRLocationData(11110416, f"Demon's Catalyst", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110417, f"Soul of a Brave Warrior - Up the Staircase", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110418, f"Soul of a Brave Warrior - Branch leading downwards", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110419, f"Demon Ruins - Catacombs lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110420, f"Centipede Demon Defeated", f"Firebomb", DSRLocationCategory.BOSS),
    DSRLocationData(11110421, f"Orange Charred Ring", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110422, f"Green Titanite Shard - 2x Green Titanite Shards at Corpse in Centipede Arena", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110423, f"Demon Ruins Shortcut opened", f"Firebomb", DSRLocationCategory.DOOR),
],
"Lost Izalith": [
    DSRLocationData(11110424, f"Lost Izalith - Lava Pits lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110425, f"Soul of a Brave Warrior - Lying around a Column following the Roots", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110426, f"Soul of a Brave Warrior - Patch of Ground uncovered by Lava", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110427, f"Soul of a Great Hero - In Chest inside of an Opening left of the Tower", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110428, f"Twin Humanities - Corpse on Broken Bridge of the second Tower", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110429, f"Divine Blessing - First Divine Blessing Hidden in Lava", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110430, f"Divine Blessing - Second Divine Blessing Hidden in Lava", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110431, f"Lost Izalith - Past Illusory Wall lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110432, f"Large Soul of a Brave Warrior - Left of the Stairs to Chaos Eater", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110433, f"Soul of a Hero - Around the Block", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110434, f"Rare Ring of Sacrifice - On the Ledge near Soul of a Hero", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110435, f"Demon Titanite - 2x Demon Titanite Drop from Titanite Demon near Shortcut", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110436, f"Twinkling Titanite - Drop from Twinkling Titanite near Titanite Demon", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110437, f"Demon Ruins Shortcut opened", f"Firebomb", DSRLocationCategory.DOOR),
    DSRLocationData(11110438, f"Red Titanite Chunk - Inside Chaos Eater Pit", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110439, f"Green Titanite Shard - 2x Green Titanite Shards Inside Chaos Eater Pit", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110440, f"Soul of a Brave Warrior - Inside Chaos Eater Pit", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110441, f"Red Titanite Slab - In Chest at Dead-End of Chaos Eater Pit", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110442, f"Pyromancy: Chaos Fire Whip", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110443, f"Bed of Chaos Defeated", f"Firebomb", DSRLocationCategory.BOSS),
    DSRLocationData(11110444, f"Lord Soul", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110445, f"Lost Izalith - Heart of Chaos lit", f"Firebomb", DSRLocationCategory.BONFIRE),
],
"The Catacombs": [
    DSRLocationData(11110446, f"Catacombs - Necromancer Cave lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110447, f"Catacombs Door 1 opened", f"Firebomb", DSRLocationCategory.DOOR),
    DSRLocationData(11110448, f"Lucerne", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110449, f"Large Soul of a Nameless Soldier - Left of the Entrance to Room with Skeleton Archer", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110450, f"Soul of a Proud Knight - Hidden Behind Pots", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110451, f"Twinkling Titanite - Drop from Crystal Lizard further up the Staircase", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110452, f"Twinkling Titanite - Drop from Crystal Lizard further down the Staircase", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110453, f"Soul of a Proud Knight - Third Niche", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110454, f"Soul of a Proud Knight - Final Niche", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110455, f"Great Scythe", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110456, f"Catacombs - Past Illusory Wall lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110457, f"Catacombs Door 2 opened", f"Firebomb", DSRLocationCategory.DOOR),
    DSRLocationData(11110458, f"Green Titanite Shard - On Platform near Vamos", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110459, f"Catacombs - Vamos lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110460, f"Miracle: Tranquil Walk of Peace", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110461, f"Demon Titanite - Drop from Titanite Demon near Tomb", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110462, f"Eye of Death - 3x Eye of Death behind Titanite Demon", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110463, f"Large Soul of a Nameless Soldier - Near Ladder", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110464, f"Soul of a Proud Knight - Before Descent", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110465, f"White Titanite Chunk - Drop from Axe-wielding Black Knight", f"Firebomb", DSRLocationCategory.DOOR),
    DSRLocationData(11110466, f"Large Soul of a Nameless Soldier - First Ledge Drop", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110467, f"Holy Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110468, f"Pinwheel Defeated", f"Firebomb", DSRLocationCategory.BOSS),
    DSRLocationData(11110469, f"Rite of Kindling", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110470, f"Soul of a Proud Knight - Up the Slope", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Tomb of the Giants": [
    DSRLocationData(11110471, f"Large Soul of a Proud Knight - Near Giant Skeleton", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110472, f"Humanity - Corpse on Ledge", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110473, f"Tomb of the Giants - Patches lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110474, f"Large Soul of a Proud Knight - First Corpse in Pit", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110475, f"Large Soul of a Proud Knight - Second Corpse in Pit", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110476, f"Skull Lantern", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110477, f"Eye of Death - 3x Eye of Death through Square Hole", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110478, f"Large Divine Ember", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110479, f"Soul of a Brave Warrior - Corpse Near Dead Blacksmith", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110480, f"Soul of a Brave Warrior - ", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110481, f"Effigy Shield", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110482, f"Tomb of the Giants lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110483, f"Covetous Silver Serpent Ring", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110484, f"White Titanite Chunk - Drop from Halberd-wielding Black Knight", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110485, f"Soul of a Brave Warrior - Corpse behind Archer", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110486, f"Twinkling Titanite - Drop from Crystal Lizard near Paladin", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110487, f"Black Phantom Paladin Loot", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110488, f"Humanity - Drop from Black Phantom Paladin", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110489, f"White Titanite Slab - By Wall", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110490, f"White Titanite Chunk - Corpse in Left Corner", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110491, f"White Titanite Chunk - By Path", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110492, f"Soul of a Hero - Ledge Before Boss", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110493, f"Gravelord Nito Defeated", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110494, f"Lord Soul", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110495, f"Tomb of the Giants - Altar of the Gravelord lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110496, f"Paladin Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Kiln of the First Flame": [
    DSRLocationData(11110497, f"Black Knight Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110498, f"Gwyn, Lord of Cinder Defeated", f"Firebomb", DSRLocationCategory.BOSS),
    DSRLocationData(11110499, f"Soul of Gwyn, Lord of Cinder", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Sanctuary Garden": [
    DSRLocationData(11110500, f"Oolacile - Sanctuary Garden lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110501, f"Sanctuary Guardian Defeated", f"Firebomb", DSRLocationCategory.BOSS),
    DSRLocationData(11110502, f"Guardian Soul", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Oolacile Sanctuary": [
...
"Royal Wood": [
    ...
    DSRLocationData(11110506, f"Blue Titanite Slab - In Chest at Pool", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110507, f"Guardian Leggings", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110508, f"Twinkling Titanite - Drop from Crystal Lizard past Stone Guardian", f"Firebomb", DSRLocationCategory.ITEM_LOT),
