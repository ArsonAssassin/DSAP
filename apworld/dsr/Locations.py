...
"Tomb of the Giants": [
    ...
    DSRLocationData(f"White Titanite Chunk - Drop from Halberd-wielding Black Knight", f"Firebomb", DSRLocationCategory.ITEM_LOT),
...
"Royal Wood": [
    ...
    DSRLocationData(f"Guardian Leggings", f"Firebomb", DSRLocationCategory.ITEM_LOT),
