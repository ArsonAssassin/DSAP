...
"Sen's Fortress": [
    ...
    DSRLocationData(11110614, f"Large Soul of a Proud Knight - Sen's Fortress 3", f"Firebomb", DSRLocationCategory.ITEM_LOT),
...
"The Duke's Archives - After Archive Tower Giant Door Key": [    
    ...
    DSRLocationData(11110385, f"Enchanted Falchion", f"Firebomb", DSRLocationCategory.ITEM_LOT), 
