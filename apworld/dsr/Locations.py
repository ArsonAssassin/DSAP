...
"Northern Undead Asylum": [
    DSRLocationData(11110002, f"Undead Asylum - Courtyard lit", f"Undead Asylum - Courtyard lit", DSRLocationCategory.BONFIRE),
...
"Northern Undead Asylum - After F2 East Door": [
    DSRLocationData(11110009, f"Asylum Demon Defeated", f"Asylum Demon Defeated", DSRLocationCategory.BOSS),
    DSRLocationData(11110010, f"Big Pilgrim's Key", f"Big Pilgrim's Key", DSRLocationCategory.SKIP),
...
"Firelink Shrine": [
    DSRLocationData(11110013, f"Firelink Shrine lit", f"Firelink Shrine lit", DSRLocationCategory.BONFIRE),
...
"Upper Undead Burg": [
    DSRLocationData(11110567, f"Soul of a Lost Undead - Upper Undead Burg 1", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110568, f"Soul of a Lost Undead - Window Corpse", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110569, f"Soul of a Lost Undead - Upper Undead Burg 3", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110570, f"Soul of a Lost Undead - Upper Undead Burg 4", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    ...
    DSRLocationData(11110039, f"Undead Burg lit", f"Undead Burg lit", DSRLocationCategory.BONFIRE),
    ...
    DSRLocationData(11110053, f"Taurus Demon Defeated", f"Tauros Demon Defeated", DSRLocationCategory.BOSS),
    DSRLocationData(11110054, f"Large Soul of a Lost Undead - After Taurus", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    ...
    DSRLocationData(11110058, f"Undead Burg - Sunlight Altar lit", f"Undead Burg - Sunlight Altar lit", DSRLocationCategory.BONFIRE),
...
"Undead Parish": [
    ...
    DSRLocationData(11110066, f"Undead Parish lit", f"Undead Parish lit", DSRLocationCategory.BONFIRE),
...
"Northern Undead Asylum - Second Visit Behind F2 West Door": [    
    ...
    DSRLocationData(11110080, f"Stray Demon Defeated", f"Stray Demon Defeated", DSRLocationCategory.BOSS),
],
"Northern Undead Asylum - Second Visit Snuggly Trades": [
    ...
    DSRLocationData(11110085, f"Twinkling Titanite - Snuggly Purple Moss", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110086, f"Twinkling Titanite - Snuggly Blooming Moss", f"Firebomb", DSRLocationCategory.ITEM_LOT),
...
"Lower Undead Burg": [
    ...
    DSRLocationData(11110565, f"Thief Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110566, f"Target Shield", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110107, f"Undead Burg Female Merchant Shortcut opened", f"Firebomb", DSRLocationCategory.DOOR),
    DSRLocationData(11110108, f"Capra Demon Defeated", f"Capra Demon Defeated", DSRLocationCategory.BOSS),
...
"Depths": [
    ...
    DSRLocationData(11110564, f"Soul of a Nameless Soldier - Giant Rat Room Entrance", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    ...
    DSRLocationData(11110127, f"Gaping Dragon Defeated", f"Gaping Dragon Defeated", DSRLocationCategory.BOSS),
...
"Depths - After Sewer Chamber Key": [
    ...
    DSRLocationData(11110132, f"Depths lit", f"Depths lit", DSRLocationCategory.BONFIRE),
],
"Depths to Blighttown Door": [
...
"Blighttown": [
    ...
    DSRLocationData(11110138, f"Blighttown Catwalk lit", f"Blighttown Catwalk lit", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110139, f"Soul of a Proud Knight - Below Shadow Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110140, f"Soul of a Proud Knight - Corpse on Wooden Structure Ledge", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110141, f"Shadow Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110142, f"Soul of a Proud Knight - Corpse in Wooden Structure near Third Catwalk", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    ...
    DSRLocationData(11110148, f"Large Soul of a Proud Knight - Corpse below Swamp Entrance", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110595, f"Whip", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    ...
    DSRLocationData(11110152, f"Blighttown Swamp lit", f"Blighttown Swamp lit", DSRLocationCategory.BONFIRE),
    ...
    DSRLocationData(11110157, f"Large Soul of a Proud Knight - Corpse between Bonfire and Great Hollow Entrance", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110158, f"Large Titanite Shard - Near Server", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    ...
    DSRLocationData(11110560, f"Soul of Quelaag", f"Firebomb", DSRLocationCategory.ENEMY_DROP),
...
"Valley of the Drakes": [
    DSRLocationData(11110617, f"Humanity - Valley of the Drakes", f"Firebomb", DSRLocationCategory.ITEM_LOT),
...
"Darkroot Basin": [
    ...
    DSRLocationData(11110577, f"Large Soul of a Nameless Soldier - Darkroot Hydra", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    ...
    DSRLocationData(11110189, f"Darkroot Basin lit", f"Darkroot Basin lit", DSRLocationCategory.BONFIRE),
...
"Darkroot Garden": [
    ...
    DSRLocationData(11110194, f"Darkroot Garden lit", f"Darkroot Garden lit", DSRLocationCategory.BONFIRE),
    ...
    DSRLocationData(11110200, f"Moonlight Butterfly Defeated", f"Moonlight Butterfly Defeated", DSRLocationCategory.BOSS),
    DSRLocationData(11110557, f"Soul of the Moonlight Butterfly", f"Firebomb", DSRLocationCategory.ENEMY_DROP),
...
"Darkroot Garden - Behind Artorias Door": [
    ...
    DSRLocationData(11110578, f"Large Soul of a Brave Warrior - Darkroot Garden Cats", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110205, f"Shiva Loot", f"Firebomb", DSRLocationCategory.ENEMY_DROP), 
    DSRLocationData(11110206, f"Humanity - Shiva", f"Firebomb", DSRLocationCategory.ENEMY_DROP),
    DSRLocationData(11110207, f"Pharis Loot", f"Firebomb", DSRLocationCategory.ENEMY_DROP),
    DSRLocationData(11110208, f"Twin Humanities - Pharis", f"Firebomb", DSRLocationCategory.ENEMY_DROP),
    ...
    DSRLocationData(11110211, f"Great Grey Wolf Sif Defeated", f"Great Grey Wolf Sif Defeated", DSRLocationCategory.BOSS),
    DSRLocationData(11110212, f"Best Boi Loot", f"Firebomb", DSRLocationCategory.ENEMY_DROP),
    DSRLocationData(11110559, f"Soul of Sif", f"Firebomb", DSRLocationCategory.ENEMY_DROP),
    DSRLocationData(11110213, f"Hornet Ring", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"The Great Hollow": [
    DSRLocationData(11110214, f"The Great Hollow lit", f"The Great Hollow lit", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110586, f"Titanite Chunk - Drop on Top Branch", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110587, f"Blue Titanite Chunk - Second Last Drop before Floor", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110588, f"White Titanite Chunk - Third Last Drop before Floor", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110589, f"Red Titanite Chunk - Last Drop before Floor", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110590, f"Blue Titanite Chunk - Drop on Branch into Hole", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110591, f"White Titanite Chunk - Drop below Floor", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    ...
    DSRLocationData(11110225, f"Large Soul of a Nameless Soldier - Corpse Entry to Basilisks", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110592, f"Large Soul of a Nameless Soldier - Corpse on Lower Floor with Basilisks", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110593, f"Titanite Chunk - Corpse on Mushroom", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110594, f"Red Titanite Chunk - Near Top Branch Drop", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Ash Lake": [
    DSRLocationData(11110226, f"Ash Lake lit", f"Ash Lake lit", DSRLocationCategory.BONFIRE),
    ...
    DSRLocationData(11110231, f"Ash Lake - Stone Dragon lit", f"Ash Lake - Stone Dragon lit", DSRLocationCategory.BONFIRE),
],
"Sen's Fortress": [
    DSRLocationData(11110610, f"Large Soul of a Proud Knight - Sen's Fortress 1", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110611, f"Divine Blessing - Sen's Fortress", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110612, f"Large Soul of a Proud Knight - Sen's Fortress 2", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110613, f"Rare Ring of Sacrifice - Sen's Fortress", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110614, f"Large Soul of a Proud Knight - Corpse after Ladder out of Pit", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110615, f"Large Soul of a Proud Knight - Sen's Fortress 4", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    ...
    DSRLocationData(11110244, f"Lightning Spear", f"Firebomb", DSRLocationCategory.ENEMY_DROP),
    ...
    DSRLocationData(11110254, f"Large Titanite Shard - Corpse bombed by Giant", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110255, f"Ricard's Rapier", f"Firebomb", DSRLocationCategory.ENEMY_DROP),
    ...
    DSRLocationData(11110258, f"Iron Golem Defeated", f"Iron Golem Defeated", DSRLocationCategory.BOSS),
    DSRLocationData(11110259, f"Core of an Iron Golem", f"Firebomb", DSRLocationCategory.ENEMY_DROP),
],
"Sen's Fortress - After Cage Key": [
    DSRLocationData(11110260, f"Soul of a Hero - Sen's Fortress Cage", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Anor Londo": [
    DSRLocationData(11110261, f"Anor Londo lit", f"Anor Londo lit", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110262, f"Demon Titanite - Anor Londo Giants", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110263, f"Crystal Halberd", f"Firebomb", DSRLocationCategory.ENEMY_DROP),
    ...
    DSRLocationData(11110267, f"Anor Londo - Darkmoon Tomb lit", f"Anor Londo - Darkmoon Tomb lit", DSRLocationCategory.BONFIRE),
    ...
    DSRLocationData(11110273, f"Anor Londo - Residence lit", f"Anor Londo - Residence lit", DSRLocationCategory.BONFIRE),
    ...
    DSRLocationData(11110616, f"Havel's Set 2", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    ...
    DSRLocationData(11110279, f"Occult Club", f"Firebomb", DSRLocationCategory.ENEMY_DROP),
    ...
    DSRLocationData(11110282, f"Gold Coin - Anor Londo Mimic", f"Firebomb", DSRLocationCategory.ENEMY_DROP),
    DSRLocationData(11110283, f"Silver Coin - Anor Londo Mimic", f"Firebomb", DSRLocationCategory.ENEMY_DROP),
    ...
    DSRLocationData(11110293, f"Ornstein and Smough Defeated", f"Ornstein and Smough Defeated", DSRLocationCategory.BOSS),
    DSRLocationData(11110561, f"Soul of Ornstein", f"Firebomb", DSRLocationCategory.ENEMY_DROP),
    DSRLocationData(11110562, f"Soul of Smough", f"Firebomb", DSRLocationCategory.ENEMY_DROP),
    ...
    DSRLocationData(11110555, f"Anor Londo Chamber of the Princess lit", f"Anor Londo Chamber of the Princess lit", DSRLocationCategory.BONFIRE),
],
"Painted World of Ariamis": [
    ...
    DSRLocationData(11110571, f"Soul of a Proud Knight - Painted World 1", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110572, f"Soul of a Proud Knight - Painted World 2", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110575, f"Soul of a Proud Knight - Painted World 3", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110573, f"Ring of Sacrifice - Painted World", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110574, f"Soul of a Brave Warrior - Painted World 2", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110576, f"Soul of a Brave Warrior - Painted World 3", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    ...
    DSRLocationData(11110324, f"Large Titanite Shard", f"Firebomb", DSRLocationCategory.ENEMY_DROP),
    DSRLocationData(11110325, f"Crossbreed Priscilla Defeated", f"Crossbreed Priscilla Defeated", DSRLocationCategory.BOSS),
...
"Upper New Londo Ruins": [
    ...
    DSRLocationData(11110339, f"Large Soul of a Nameless Soldier - Near Ladder Shortcut", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    ...
    DSRLocationData(11110344, f"Large Soul of a Nameless Soldier - Corpse before Seal", f"Firebomb", DSRLocationCategory.ITEM_LOT),
...
"Lower New Londo Ruins": [
    DSRLocationData(11110618, f"Humanity - Lower New Londo Ruins", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110619, f"Large Soul of a Proud Knight - Right Path after Stairs", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110349, f"Large Soul of a Proud Knight - Corpse in Shed", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    ...
    DSRLocationData(11110352, f"Large Soul of a Proud Knight - Corpse before Illusory Wall", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110353, f"Titanite Chunk - Chest before Four Kings", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110354, f"Cracked Red Eye Orb - New Londo", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110355, f"Large Soul of a Proud Knight - Corpse on Stairs", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110356, f"Titanite Chunk - Chest behind Illusory Wall", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"The Abyss": [
    DSRLocationData(11110357, f"Four Kings Defeated", f"Four Kings Defeated", DSRLocationCategory.BOSS),
    DSRLocationData(11110358, f"Bequeathed Lord Soul Shard (Four Kings)", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110359, f"The Abyss lit", f"The Abyss lit", DSRLocationCategory.BONFIRE),
],
"The Duke's Archives": [
    DSRLocationData(11110360, f"Duke's Archives - Entrance lit", f"Duke's Archives - Entrance lit", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110361, f"Broken Pendant", f"Firebomb", DSRLocationCategory.ENEMY_DROP),
...
"The Duke's Archives - After Archive Tower Giant Door Key": [    
    ...
    DSRLocationData(11110382, f"Duke's Archives - Balcony lit", f"Duke's Archives - Balcony lit", DSRLocationCategory.BONFIRE),
    ...
    DSRLocationData(11110385, f"Enchanted Falchion", f"Firebomb", DSRLocationCategory.ENEMY_DROP), 
...
"The Duke's Archives - Giant Cell": [
    DSRLocationData(11110392, f"Fire Keeper Soul - Archives Giant Cell", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Crystal Cave": [
    ...
    DSRLocationData(11110400, f"Seath the Scaleless Defeated", f"Seath the Scaleless Defeated", DSRLocationCategory.BOSS),
    DSRLocationData(11110401, f"Bequeathed Lord Soul Shard (Seath)", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110402, f"Crystal Cave lit", f"Crystal Cave lit", DSRLocationCategory.BONFIRE),
],
"The Duke's Archives - First Arena after Seath's Death": [
...
"Demon Ruins": [
    DSRLocationData(11110405, f"Demon Ruins - Entrance lit", f"Demon Ruins - Entrance lit", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110406, f"Gold-Hemmed Black Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110407, f"Ceaseless Discharge Defeated", f"Ceaseless Discharge Defeated", DSRLocationCategory.BOSS),
    ...
    DSRLocationData(11110412, f"Demon Ruins - Staircase lit", f"Demon Ruins - Staircase lit", DSRLocationCategory.BONFIRE),
    ...
    DSRLocationData(11110609, f"Soul of a Proud Knight - Ledge Corpse Top of Stairs", f"Firebomb", DSRLocationCategory.ITEM_LOT),
...
"Demon Ruins - Behind Golden Fog Wall": [
    DSRLocationData(11110597, f"Large Soul of a Brave Warrior - Demon Ruins 1", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110598, f"Large Soul of a Brave Warrior - Demon Ruins 2", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110599, f"Large Soul of a Brave Warrior - Demon Ruins 3", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110600, f"Large Soul of a Brave Warrior - Demon Ruins 4", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110601, f"Large Soul of a Brave Warrior - Demon Ruins 5", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110602, f"Soul of a Brave Warrior - On Platform Below Roots to Centipede", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110603, f"Large Soul of a Brave Warrior - Demon Ruins 6", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    ...
    DSRLocationData(11110421, f"Demon Ruins - Catacombs lit", f"Demon Ruins - Catacombs lit", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110422, f"Centipede Demon Defeated", f"Centipede Demon Defeated", DSRLocationCategory.BOSS),
...
"Lost Izalith": [
    DSRLocationData(11110604, f"Large Soul of a Brave Warrior - Lost Izalith 1", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110605, f"Large Soul of a Brave Warrior - Lost Izalith 2", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110606, f"Large Soul of a Brave Warrior - Lost Izalith 3", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110607, f"Large Soul of a Brave Warrior - Lost Izalith 4", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110608, f"Large Soul of a Brave Warrior - Lost Izalith 5", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110411, f"Thorns Set", f"Firebomb", DSRLocationCategory.ENEMY_DROP),
    DSRLocationData(11110426, f"Lost Izalith - Lava Pits lit", f"Lost Izalith - Lava Pits lit", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110427, f"Soul of a Brave Warrior - First Platform after Entrance", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110428, f"Soul of a Brave Warrior - Near Soul of a Great Hero Chest", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    ...
    DSRLocationData(11110433, f"Lost Izalith - Past Illusory Wall lit", f"Lost Izalith - Past Illusory Wall lit", DSRLocationCategory.BONFIRE),
    ...
    DSRLocationData(11110596, f"Red Titanite Chunk - After Chaos Eater Pit", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110444, f"Pyromancy: Chaos Fire Whip", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110563, f"Izalith Catalyst", f"Firebomb", DSRLocationCategory.ENEMY_DROP),
    DSRLocationData(11110445, f"Bed of Chaos Defeated", f"Bed of Chaos Defeated", DSRLocationCategory.BOSS),
    DSRLocationData(11110446, f"Lord Soul (Bed of Chaos)", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110447, f"Lost Izalith - Heart of Chaos lit", f"Lost Izalith - Heart of Chaos lit", DSRLocationCategory.BONFIRE),
],
"The Catacombs": [
    DSRLocationData(11110448, f"Catacombs - Necromancer Cave lit", f"Catacombs - Necromancer Cave lit", DSRLocationCategory.BONFIRE),
],
"The Catacombs - Door 1": [
    DSRLocationData(11110449, f"Catacombs Door 1 opened", f"Firebomb", DSRLocationCategory.DOOR),
],
"The Catacombs - After Door 1": [  
    DSRLocationData(11110579, f"Darkmoon Seance Ring", f"Firebomb", DSRLocationCategory.ITEM_LOT),  
    ...
    DSRLocationData(11110458, f"Catacombs - Past Illusory Wall lit", f"Catacombs - Past Illusory Wall lit", DSRLocationCategory.BONFIRE),
    ...
    DSRLocationData(11110461, f"Catacombs - Vamos lit", f"Catacombs - Vamos lit", DSRLocationCategory.BONFIRE),
    ...
    DSRLocationData(11110469, f"Holy Set", f"Firebomb", DSRLocationCategory.ENEMY_DROP),
    DSRLocationData(11110552, f"Mace", f"Firebomb", DSRLocationCategory.ENEMY_DROP),
    DSRLocationData(11110470, f"Pinwheel Defeated", f"Pinwheel Defeated", DSRLocationCategory.BOSS),
...
"Tomb of the Giants": [
    DSRLocationData(11110580, f"Large Soul of a Proud Knight - Tomb of the Giants 1", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110581, f"Large Soul of a Proud Knight - Tomb of the Giants 2", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110582, f"Soul of a Brave Warrior - Tomb of the Giants 1", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110583, f"Soul of a Hero - Tomb of the Giants 1", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110584, f"White Titanite Chunk - Outside Nito", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110585, f"Large Soul of a Proud Knight - Giant Coffin Drop", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    ...
    DSRLocationData(11110475, f"Tomb of the Giants - Patches lit", f"Tomb of the Giants - Patches lit", DSRLocationCategory.BONFIRE),
    ...
    DSRLocationData(11110483, f"Tomb of the Giants lit", f"Tomb of the Giants lit", DSRLocationCategory.BONFIRE),
    ...
    DSRLocationData(11110488, f"Paladin Leeroy Loot", f"Firebomb", DSRLocationCategory.ENEMY_DROP),
...
"Kiln of the First Flame": [ 
    ...
    DSRLocationData(11110499, f"Gwyn, Lord of Cinder Defeated", f"Gwyn, Lord of Cinder Defeated", DSRLocationCategory.BOSS),
    DSRLocationData(11110500, f"Soul of Gwyn, Lord of Cinder", f"Firebomb", DSRLocationCategory.ENEMY_DROP),
],                        
#"Sanctuary Garden": [     
