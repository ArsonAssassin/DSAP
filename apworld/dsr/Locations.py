...
location_tables = {
"Undead Asylum Cell": [
    DSRLocationData(11110000, f"Dungeon Cell Key", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110001, f"Undead Asylum Cell Door opened", f"Firebomb", DSRLocationCategory.DOOR),
],
"Northern Undead Asylum": [
    DSRLocationData(11110002, f"Undead Asylum - Courtyard lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110003, f"Undead Asylum - Boss Door opened", f"Firebomb", DSRLocationCategory.DOOR),
    ...
    DSRLocationData(11110011, f"Undead Asylum Big Pilgrim Door opened", f"Firebomb", DSRLocationCategory.DOOR),
...
"Upper Undead Burg": [
    DSRLocationData(11110033, f"Soul of a Lost Undead - Left after dropping from Ledge behind Barrels", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110034, f"Rubbish - Corpse near Hanging Hollows", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110035, f"Humanity - Corpse at End of Walkway", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110036, f"Soul of a Lost Undead - Corpse under Stairs after Fog Gate", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110037, f"Wooden Shield", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110038, f"Undead Burg lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110039, f"Uchigatana", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110040, f"Orange Guidance Soapstone", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110041, f"Residence Key", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110042, f"Throwing Knifes - x10 Throwing Knifes at Corpse on Rooftop", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110043, f"Light Crossbow and Standard Bolts", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110044, f"Black Firebomb - 5x Black Firebombs in Chest inside Building", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110045, f"Soul of a Lost Undead - Corpse near Firebombers", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110046, f"Titanite Chunk - Drop from Black Knight guarding Blue Tearstone Ring", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110047, f"Blue Tearstone Ring", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110048, f"Havel's Ring", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110049, f"Twinkling Titanite - Drop from Crystal Lizard hidden in Barrel", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110050, f"Undead Burg Watchtower Upper opened", f"Firebomb", DSRLocationCategory.DOOR),
    DSRLocationData(11110051, f"Undead Burg Watchtower Lower opened", f"Firebomb", DSRLocationCategory.DOOR),
    DSRLocationData(11110052, f"Tauros Demon Defeated", f"Firebomb", DSRLocationCategory.BOSS),
    DSRLocationData(11110053, f"Large Soul of a Lost Undead - Hidden in Boxes after Taurus Demon", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110054, f"White Sign Soapstone", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110055, f"Claymore", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110056, f"Soul of a Nameless Soldier - On Dragon Bridge", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110057, f"Undead Burg - Sunlight Altar lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110058, f"Undead Burg Sunlight Altar opened", f"Firebomb", DSRLocationCategory.DOOR),
],
"Upper Undead Burg - Pine Resin Chest": [
    DSRLocationData(11110059, f"Gold Pine Resin - 3x Gold Pine Resin in Chest behind Locked Door", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Undead Parish": [
    DSRLocationData(11110060, f"Titanite Chunk - Drop from Black Knight in Tower", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110061, f"Alluring Skull - On Ledge past Archers", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110062, f"Mystery Key", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110063, f"Large Soul of a Lost Undead - Corpse hanging on Beam", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110064, f"Knight Shield", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110065, f"Undead Parish lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110066, f"Halberd", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110067, f"Basement Key", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110068, f"Titanite Shard - Drop from Tower Knight", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110069, f"Fire Keeper Soul - Behind Tower Knight", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110070, f"Large Soul of a Nameless Soldier - Corpse in Room after Hollows", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110071, f"Humanity - Corpse in Barrel", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110072, f"Bell Gargoyles Defeated", f"Firebomb", DSRLocationCategory.BOSS),
    DSRLocationData(11110073, f"Homeward Bone - After First Bell", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Firelink Shrine - After Undead Parish Elevator": [
    DSRLocationData(11110074, f"Undead Asylum F2 West Key", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Northern Undead Asylum - Second Visit Behind F2 West Door": [    
    DSRLocationData(11110075, f"Undead Asylum F2 West Door opened", f"Firebomb", DSRLocationCategory.DOOR),
    DSRLocationData(11110076, f"Crest Shield", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110077, f"Rusted Iron Ring", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110078, f"Peculiar Doll", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110079, f"Stray Demon Defeated", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Northern Undead Asylum - Second Visit Snuggly Trades": [
    DSRLocationData(11110080, f"Souvenir of Reprisal - Trade in Pendant", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110081, f"Titanite Chunk - Trade in Rubbish", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110082, f"White Titanite Chunk - Trade in Sunlight Medal", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110083, f"Twinkling Titanite - Trade in Bloodred Moss Clump", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110084, f"Twinkling Titanite - Trade in Purple Moss Clump", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110085, f"Twinkling Titanite - Trade in Blooming Purple Moss Clump", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110086, f"Purging Stone - Trade in Cracked Red Eye Orb", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110087, f"Ring of Sacrifice - Trade in Humanity", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110088, f"Rare Ring of Sacrifice - Trade in Twin Humanities", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110089, f"Demon Titanite - Trade in Prism Stone", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110090, f"Demon Titanite - Trade in Dung Pie", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110091, f"Red Titanite Chunk - Trade in Pyromancy Flame(Basic)", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110092, f"Red Titanite Slab - Trade in Pyromancy Flame(Ascended)", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110093, f"Dragon Scale - Trade in Egg Vermifuge", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110094, f"Old Witch's Ring - Trade in Sunlight Maggot", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110095, f"Demon's Great Hammer - Trade in Sack", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110096, f"Ring of Fog - Trade in Skull Lantern", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110097, f"Divine Blessing - Trade in Ring of the Sun Princess", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110098, f"Ring of Favor and Protection - Trade in Xanthous Crown", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110099, f"Sorcery: Pursuers - Trade in Soul of Manus", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],  
"Lower Undead Burg": [
    DSRLocationData(11110100, f"Undead Burg Basement opened", f"Firebomb", DSRLocationCategory.DOOR),
    DSRLocationData(11110101, f"Undead Burg -> Lower Undead Burg opened", f"Firebomb", DSRLocationCategory.DOOR),
    DSRLocationData(11110102, f"Twin Humanities - Corpse to the Right of Torch Hollows", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110103, f"Mail Breaker", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110104, f"Large Soul of a Lost Undead - Corpse in Barrel of Arched Corridor", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110105, f"Large Soul of a Lost Undead - Corpse Near Large Gate", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110106, f"Undead Burg Female Merchant Shortcut opened", f"Firebomb", DSRLocationCategory.DOOR),
    DSRLocationData(11110107, f"Capra Demon Defeated", f"Firebomb", DSRLocationCategory.BOSS),
    DSRLocationData(11110108, f"Key to Depths", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Lower Undead Burg - After Residence Key": [
    DSRLocationData(11110109, f"Sorcerer Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110110, f"Sorcerer's Catalyst", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Depths": [
    DSRLocationData(11110111, f"Soul of a Nameless Soldier - Corpse behind Boxes", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110112, f"Large Ember", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110113, f"Spider Shield - Ledge near Giant Rat", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110114, f"Soul of a Nameless Soldier - Baited Corpse", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110115, f"Greataxe", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110116, f"Sewer Chamber Key", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110117, f"Soul of a Nameless Soldier - Corpse near Drain Hole", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110118, f"Soul of a Nameless Soldier - Corpse near Giant Rat", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110119, f"Large Titanite Shard - Corpse behind Pillar", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110120, f"Large Soul of a Nameless Soldier - Corpse under Stairs with Basilisks", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110121, f"Soul of a Nameless Soldier - Corpse in Passage with Basilisks", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110122, f"Ring of the Evil Eye", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110123, f"Humanity - Corpse behind Hole", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110124, f"Heavy Crossbow and Heavy Bolts", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110125, f"Depths Shortcut opened", f"Firebomb", DSRLocationCategory.DOOR),
    DSRLocationData(11110126, f"Gaping Dragon Defeated", f"Firebomb", DSRLocationCategory.BOSS),
    DSRLocationData(11110127, f"Blighttown Key", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110128, f"Warrior Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110129, f"Depths -> Blighttown opened", f"Firebomb", DSRLocationCategory.DOOR),
],
"Depths - After Sewer Chamber Key": [
    DSRLocationData(11110130, f"Depths Bonfire Room opened", f"Firebomb", DSRLocationCategory.DOOR),
    DSRLocationData(11110131, f"Depths lit", f"Firebomb", DSRLocationCategory.BONFIRE),
],
"Blighttown": [
    DSRLocationData(11110132, f"Soul of a Proud Knight - End of Wooden Structure", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110133, f"Large Soul of a Nameless Soldier - Corpse at Left Ramp", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110134, f"Blooming Purple Moss Clump - 3x Blooming Purple Moss Clumps on suspended Walkway", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110135, f"Humanity - Narrow Path", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110136, f"Iaito", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110137, f"Blighttown Catwalk lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110138, f"Soul of a Proud Knight - Drop onto Platform near Infested Ghoul", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110139, f"Soul of a Proud Knight - Drop to the Left of Shadow Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110140, f"Shadow Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110141, f"Soul of a Proud Knight - Corpse near Ladder with Infested Ghoul", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110142, f"Eagle Shield", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110143, f"Pyromancy: Power Within", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110144, f"Large Soul of a Nameless Soldier - Near Parasitic Wall Hugger", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110145, f"Wanderer Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110146, f"Falchion", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110147, f"Large Soul of a Proud Knight - Corpse on the Way to Bonfire", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110148, f"Dragon Scale - In Chest up the Tunnel", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110149, f"Butcher Knife", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110150, f"Humanity - 3x Humanity from Maneater Mildred", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110151, f"Blighttown Swamp lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110152, f"Large Soul of a Proud Knight - Concrete Structure with Cragspider", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110153, f"Great Club", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110154, f"Pyromancer Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110155, f"Pyromancy: Poison Mist", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110156, f"Large Soul of a Proud Knight - Right Side of Swamp", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110157, f"Large Titanite Shard - Corpse near Server", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110158, f"Server", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110159, f"Green Titanite Shard - Left of Tree", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110160, f"Plank Shield", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110161, f"Twin Humanities - In Chest behind Hidden Path near Corpse", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110162, f"Large Titanite Shard - En Route to Quelaag's Domain", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110163, f"Chaos Witch Quelaag Defeated", f"Firebomb", DSRLocationCategory.BOSS),
    DSRLocationData(11110164, f"Quelaag's Domain lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110165, f"Soul of a Proud Knight - Ledge near Blowdart Snipers", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110166, f"Fire Keeper Soul - Behind Bars near Blowdart Snipers", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110167, f"Crimson Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110168, f"Tin Banishment Catalyst", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110169, f"Sorcery: Remedy", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110170, f"Key to New Londo Ruins", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Valley of the Drakes": [
    DSRLocationData(11110171, f"New Londo Ruins -> Valley of the Drakes opened", f"Firebomb", DSRLocationCategory.DOOR),
    DSRLocationData(11110172, f"Large Soul of a Nameless Soldier - Near New Londo Ruins Door", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110173, f"Astora's Straight Sword", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110174, f"Dragon Crest Shield", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110175, f"Soul of a Proud Knight - Past Undead Dragon", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110176, f"Dragon Scale - Drop from Undead Dragon in Valley of the Drakes", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110177, f"Humanity - Corpse in Small Cave", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110178, f"Brigand Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110179, f"Spider Shield - Corpse with Brigand Armor Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110180, f"Red Tearstone Ring", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Valley of the Drakes - After Defeating Four Kings": [
    DSRLocationData(11110181, f"Witch Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110182, f"Beatrice's Catalyst", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Darkroot Basin": [
    DSRLocationData(11110183, f"Twinkling Titanite - Drop from Crystal Lizard near Hunter Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110184, f"Hunter Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110185, f"Longbow and Feather Arrows", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110186, f"Grass Crest Shield", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110187, f"Blue Titanite Chunk - Drop from Black Knight near Bonfire", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110188, f"Darkroot Basin lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110189, f"Undead Burg Watchtower Lower opened", f"Firebomb", DSRLocationCategory.DOOR),
    DSRLocationData(11110190, f"Knight Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110191, f"Antiquated Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Darkroot Garden": [
    DSRLocationData(11110192, f"Demon Titanite - Drop from Titanite Demon below Andre", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110193, f"Soul of a Nameless Soldier - Behind Rock", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110194, f"Darkroot Garden lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110195, f"Large Soul of a Nameless Soldier - Ents Ambush", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110196, f"Wolf Ring", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110197, f"Soul of a Proud Knight - Corpse near Frog-Ray", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110198, f"Partizan", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110199, f"Moonlight Butterfly Defeated", f"Firebomb", DSRLocationCategory.BOSS),
    DSRLocationData(11110200, f"Homeward Bone - Frozen Blacksmith", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110201, f"Watchtower Basement Key", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110202, f"Divine Ember", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Darkroot Garden - Behind Artorias Door": [
    DSRLocationData(11110203, f"Stone Knight Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110204, f"Shiva Loot", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110205, f"Humanity - 2x Humanity Drop from Shiva", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110206, f"Pharis Loot", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110207, f"Twin Humanities - Drop from Pharis", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110208, f"Soul of a Brave Warrior - Down Ladder before Stone Bridge", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110209, f"Enchanted Ember", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110210, f"Great Grey Wolf Sif Defeated", f"Firebomb", DSRLocationCategory.BOSS),
    DSRLocationData(11110211, f"Best Boi Loot", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110212, f"Hornet Ring", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"The Great Hollow": [
    DSRLocationData(11110213, f"The Great Hollow lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110214, f"Twinkling Titanite - Drop from Crystal Lizard (Random Spawn 1)", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110215, f"Twinkling Titanite - Drop from Crystal Lizard (Random Spawn 2)", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110216, f"Twinkling Titanite - Drop from Crystal Lizard (Random Spawn 3)", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110217, f"Twinkling Titanite - Drop from Crystal Lizard (Random Spawn 4)", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110218, f"Twinkling Titanite - Drop from Crystal Lizard (Random Spawn 5)", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110219, f"Twinkling Titanite - Drop from Crystal Lizard (Random Spawn 6)", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110220, f"Twinkling Titanite - Drop from Crystal Lizard (Random Spawn 7)", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110221, f"Twinkling Titanite - Drop from Crystal Lizard (Random Spawn 8)", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110222, f"Twinkling Titanite - Drop from Crystal Lizard (Random Spawn 9)", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110223, f"Chloranthy Ring", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110224, f"Large Soul of a Nameless Soldier - Before Area with three Basilisks", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Ash Lake": [
    DSRLocationData(11110225, f"Ash Lake lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110226, f"Dragon Scale - Corpse near Black Hydra", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110227, f"Dragon Scale - At the End of the Shoreline", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110228, f"Dragon Scale - Inside Hollowed Tree", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110229, f"Miracle: Great Magic Barrier", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110230, f"Ash Lake - Stone Dragon lit", f"Firebomb", DSRLocationCategory.BONFIRE),
],
"Sen's Fortress": [
    DSRLocationData(11110231, f"Sen's Fortress Main Gate opened", f"Firebomb", DSRLocationCategory.DOOR),
    DSRLocationData(11110232, f"Soul of a Brave Warrior - Inside Pots adjacent to Doorway", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110233, f"Demon Titanite - Drop from Titanite Demon in Pit 1", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110234, f"Demon Titanite - Drop from Titanite Demon in Pit 2", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110235, f"Demon Titanite - Drop from Titanite Demon in Pit 3", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110236, f"Demon Titanite - Drop from Titanite Demon in Pit 4", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110237, f"Large Soul of a Brave Warrior - Near Scythe", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110238, f"Scythe", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110239, f"Large Titanite Shard - 2x Large Titanite Shards in Chest", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110240, f"Ring of Steel Protection", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110241, f"Shotel", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110242, f"Covetous Gold Serpent Ring", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110243, f"Lightning Spear", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110244, f"Soul of a Hero - Inside Cage", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110245, f"Large Soul of a Proud Knight - Near Man-Serpent Mage", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110246, f"Black Sorcerer Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110247, f"Sorcery: Hush", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110248, f"Slumbering Dragoncrest Ring", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110249, f"Large Titanite Shard - 3x Large Titanite Shards behind Man-Serpent Soldier", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110250, f"Large Soul of a Brave Warrior - Corpse up Second Flight of Stairs", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110251, f"Sen's Fortress lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110252, f"Flame Stoneplate Ring", f"Firebomb", DSRLocationCategory.ITEM_LOT),    
    DSRLocationData(11110253, f"Large Titanite Shard - Corpse up Third Flight of Stairs", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110254, f"Ricard's Rapier", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110255, f"Sniper Crossbow and Sniper Bolts", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110256, f"Cage Key", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110257, f"Iron Golem Defeated", f"Firebomb", DSRLocationCategory.BOSS),
    DSRLocationData(11110258, f"Core of an Iron Golem", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Sen's Fortress - After Cage Key": [
    DSRLocationData(11110259, f"Soul of a Hero - Inside Cage", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Anor Londo": [
    DSRLocationData(11110260, f"Anor Londo lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110261, f"Demon Titanite - In Chest guarded by two Sentinels", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110262, f"Crystal Halberd", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110263, f"Twinkling Titanite - In Chest left of Mimic", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110264, f"Demon Titanite - In Chest under the Walkway", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110265, f"Divine Blessing - In Chest near Painting Guardian", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110266, f"Anor Londo - Darkmoon Tomb lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110267, f"Ring of the Sun's Firstborn", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110268, f"Sorcery: Great Magic Weapon", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110269, f"Black Iron Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110270, f"Greatsword", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110271, f"Black Iron Greatshield", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110272, f"Anor Londo - Residence lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110273, f"Soul of a Hero - Behind Left Silver Knight Archer", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110274, f"Sunlight Medal - 3x Sunlight Medals In Chest behind Silver Knight", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110275, f"Havel's Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110276, f"Dragon Tooth", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110277, f"Havel's Greatshield", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110278, f"Occult Club", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110279, f"Soul of a Hero - Behind Left Door", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110280, f"Demon Titanite - 2x Demon Titanite Drop from Titanite Demon below Balcony", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110281, f"Gold Coin - Drop from Mimic", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110282, f"Silver Coin - 5x Silver Coins Drop from Mimic", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110283, f"Demon Titanite - In Chest next to Bed", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110284, f"Silver Knight Set 1", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110285, f"Silver Knight Set 2", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110286, f"Anor Londo Bonfire Shortcut opened", f"Firebomb", DSRLocationCategory.DOOR),
    DSRLocationData(11110287, f"Dragonslayer Greatbow and Dragonslayer Arrow", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110288, f"Titanite Chunk - Corpse on Ledge near Bat Wing Demon", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110289, f"Hawk Ring", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110290, f"Anor Londo Giant Blacksmith Shortcut opened", f"Firebomb", DSRLocationCategory.DOOR),
    DSRLocationData(11110291, f"Anor Londo Main Hall Door opened", f"Firebomb", DSRLocationCategory.DOOR),
    DSRLocationData(11110292, f"Ornstein and Smough Defeated", f"Firebomb", DSRLocationCategory.BOSS),
    DSRLocationData(11110293, f"Lordvessel", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110294, f"Gwyndolin Defeated", f"Firebomb", DSRLocationCategory.BOSS),
    DSRLocationData(11110295, f"Soul of Gwyndolin", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110296, f"Brass Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110297, f"Miracle: Sunlight Blade", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Painted World of Ariamis": [
    DSRLocationData(11110298, f"Painted World lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110299, f"Humanity - Hanging Corpse", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110300, f"Soul of a Proud Knight", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110301, f"Twin Humanities", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110302, f"Soul of a Brave Warrior - At the Top of Second Staircase", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110303, f"Soul of a Brave Warrior - Near Snow Rats", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110304, f"Painting Guardian Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110305, f"Egg Vermifuge - Corpse hanging off Wooden Plank", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110306, f"Velka's Rapier", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110307, f"Large Soul of a Proud Knight - To the left of the Tower", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110308, f"Dark Ember", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110309, f"Red Sign Soapstone", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110310, f"Soul of a Brave Warrior - Drop off Stairs onto Ledge", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110311, f"Dragon Scale - Drop from Undead Dragon in Painted World of Ariamis", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110312, f"Bloodshield", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110313, f"Large Soul of a Proud Knight - Corpse on Bridge", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110314, f"Soul of a Proud Knight - Right Corpse near Torch Hollows", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110315, f"Soul of a Proud Knight - Left Corpse near Torch Hollows", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110316, f"Large Soul of a Proud Knight - Corpse left of Proud Knight Souls", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110317, f"Pyromancy: Acid Surge", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110318, f"Notched Whip", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110319, f"Soul of a Brave Warrior - Beside Illusory Wall", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110320, f"Pyromancy: Fire Surge", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110321, f"Annex Key", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110322, f"Twin Humanities - Painted World", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110323, f"Large Titanite Shard", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110324, f"Crossbreed Priscilla Defeated", f"Firebomb", DSRLocationCategory.BOSS),
    DSRLocationData(11110325, f"Soul of Priscilla", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110326, f"Xanthous Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Painted World of Ariamis - After Annex Key": [
    DSRLocationData(11110327, f"Miracle: Vow of Silence", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110328, f"Velka's Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110329, f"Gold Coin - Hidden behind Barrels across Gap", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Upper New Londo Ruins": [
    DSRLocationData(11110330, f"New Londo Ruins -> Valley of the Drakes opened", f"Firebomb", DSRLocationCategory.DOOR),
    DSRLocationData(11110331, f"Soul of a Nameless Soldier - Behind first Flight of Stairs", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110332, f"Estoc", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110333, f"Transient Curse - 2x Transient Curses from Corpse inside large Pot", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110334, f"Fire Keeper Soul - End of thin Walkway", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110335, f"Transient Curse - 2x Transient Curses from Corpse inside Pot behind Wall", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110336, f"Parrying Dagger", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110337, f"Transient Curse - 2x Transient Curses guarded by Banshee", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110338, f"Soul of a Nameless Soldier - Corpse at the End of the Ledge next to Ladder", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110339, f"Key to the Seal", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110340, f"Soul of a Proud Knight - Corpse next to Hole in the Wall", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110341, f"Cursebite Ring", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110342, f"Green Titanite Shard - Little Structure", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110343, f"Large Soul of a Nameless Soldier - Up the Stairs", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110344, f"Humanity - At the End of the Ledge up the Second Stairs", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110345, f"Rare Ring of Sacrifice", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110346, f"Composite Bow and Large Arrows", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110347, f"New Londo Ruins Door to the Seal opened", f"Firebomb", DSRLocationCategory.DOOR),
],
"Lower New Londo Ruins": [
    DSRLocationData(11110348, f"Large Soul of a Proud Knight - Through Door", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110349, f"Soul of a Brave Warrior - Top of Stairwell", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110350, f"Very Large Ember", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110351, f"Large Soul of a Proud Knight - Near Darkwraith Knight", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110352, f"Titanite Chunk - In Chest across the Walkway", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110353, f"Cracked Red Eye Orb - 6x Cracked Red Eye Orbs from Corpse in Well", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110354, f"Large Soul of a Proud Knight - On the Way up the Stairs", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110355, f"Titanite Chunk - In Chest at the Right Corner of the Room", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"The Abyss": [
    DSRLocationData(11110356, f"Four Kings Defeated", f"Firebomb", DSRLocationCategory.BOSS),
    DSRLocationData(11110357, f"Bequeathed Lord Soul Shard", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110358, f"The Abyss lit", f"Firebomb", DSRLocationCategory.BONFIRE),
],
"The Duke's Archives": [
    DSRLocationData(11110359, f"Duke's Archives - Entrance lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110360, f"Broken Pendant", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110361, f"Soul of a Brave Warrior - Under Imperial Staircase guarded by Crystal Soldier", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110362, f"Twinkling Titanite - In Chest at the End of Balcony", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110363, f"Twinkling Titanite - Corpse at Small Outdoor Balcony", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110364, f"Crstal Knight Shield", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110365, f"Twinkling Titanite - Drop from Crystal Lizard in Tunnel", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110366, f"Duke's Archives Cell lit", f"Firebomb", DSRLocationCategory.BONFIRE),
],
"The Duke's Archives - Getting out of Cell": [
    DSRLocationData(11110367, f"Duke's Archives Cell Door opened", f"Firebomb", DSRLocationCategory.DOOR),
    DSRLocationData(11110368, f"Archive Tower Cell Key", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110369, f"Archive Prison Extra Key", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"The Duke's Archives - After Archive Prison Extra Key": [    
    DSRLocationData(11110370, f"Large Soul of a Proud Knight - In Reah's Cell", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110371, f"Maiden Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110372, f"White Seance Ring", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110373, f"Large Soul of a Brave Warrior - In Cell with Crystal Soldier", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110374, f"Soul of a Brave Warrior - Drop down from the right Side of Ledge", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110375, f"Archive Tower Giant Door Key", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110376, f"Miracle: Soothing Sunlight", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110377, f"Miracle: Bountiful Sunlight", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"The Duke's Archives - After Archive Tower Giant Door Key": [    
    DSRLocationData(11110378, f"Avelyn", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110379, f"Twinkling Titanite - In Chest near Stairway", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110380, f"Sorcery: Strong Magic Shield", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110381, f"Duke's Archives - Balcony lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110382, f"Duke's Archives Bookshelf Door opened", f"Firebomb", DSRLocationCategory.DOOR),
    DSRLocationData(11110383, f"Blue Titanite Chunk - In Chest near Secret Library", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110384, f"Enchanted Falcion", f"Firebomb", DSRLocationCategory.ITEM_LOT), 
    DSRLocationData(11110385, f"Archive Tower Giant Cell Key", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110386, f"Crystal Ember", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110387, f"Channeler Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
...
"The Duke's Archives - Giant Cell": [
    DSRLocationData(11110388, f"Fire Keeper Soul - Door at the Back of Pisacas Cell", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Crystal Cave": [
    DSRLocationData(11110392, f"Humanity - Corpse after first invisible Path", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110393, f"Blue Titanite Chunk - Corpse next to Golem", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110394, f"Twinkling Titanite - Drop from first Crystal Lizard", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110395, f"Twinkling Titanite - Drop from second Crystal Lizard", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110396, f"Twinkling Titanite - Drop from third Crystal Lizard", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110397, f"Blue Titanite Slab - On Crystal Beam", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110398, f"Soul of a Hero - Left of Cave", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110399, f"Seath the Scaleless Defeated", f"Firebomb", DSRLocationCategory.BOSS),
    DSRLocationData(11110400, f"Bequeathed Lord Soul Shard", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110401, f"Crystal Cave lit", f"Firebomb", DSRLocationCategory.BONFIRE),
],
"The Duke's Archives - First Arena after Seath's Death": [
    DSRLocationData(11110402, f"Large Magic Ember", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110403, f"Soul of a Great Hero - Near Large Magic Ember", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Demon Ruins": [
    DSRLocationData(11110404, f"Demon Ruins - Entrance lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110405, f"Gold-Hemmed Black Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110406, f"Ceaseless Discharge Defeated", f"Firebomb", DSRLocationCategory.BOSS),
    DSRLocationData(11110407, f"Large Soul of a Proud Knight - First Jump over the Lava", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110408, f"Chaos Flame Ember", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110409, f"Soul of a Proud Knight - Corpse found while Ascending the Path", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110410, f"Thorns Set", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110411, f"Demon Ruins - Staircase lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110412, f"Green Titanite Shard - 2x Green Titanite Shards under the Staircase", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110413, f"Soul of a Proud Knight - Near Bonfire", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110414, f"Large Flame Ember", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110415, f"Soul of a Brave Warrior - Path to the Right before Fog Gate", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110416, f"Demon Firesage Defeated", f"Firebomb", DSRLocationCategory.BOSS),
    DSRLocationData(11110417, f"Demon's Catalyst", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110418, f"Soul of a Brave Warrior - Up the Staircase", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110419, f"Soul of a Brave Warrior - Branch leading downwards", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110420, f"Demon Ruins - Catacombs lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110421, f"Centipede Demon Defeated", f"Firebomb", DSRLocationCategory.BOSS),
    DSRLocationData(11110422, f"Orange Charred Ring", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110423, f"Green Titanite Shard - 2x Green Titanite Shards at Corpse in Centipede Arena", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110424, f"Demon Ruins Shortcut opened", f"Firebomb", DSRLocationCategory.DOOR),
],
"Lost Izalith": [
    DSRLocationData(11110425, f"Lost Izalith - Lava Pits lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110426, f"Soul of a Brave Warrior - Lying around a Column following the Roots", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110427, f"Soul of a Brave Warrior - Patch of Ground uncovered by Lava", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110428, f"Soul of a Great Hero - In Chest inside of an Opening left of the Tower", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110429, f"Twin Humanities - Corpse on Broken Bridge of the second Tower", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110430, f"Divine Blessing - First Divine Blessing Hidden in Lava", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110431, f"Divine Blessing - Second Divine Blessing Hidden in Lava", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110432, f"Lost Izalith - Past Illusory Wall lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110433, f"Large Soul of a Brave Warrior - Left of the Stairs to Chaos Eater", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110434, f"Soul of a Hero - Around the Block", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110435, f"Rare Ring of Sacrifice - On the Ledge near Soul of a Hero", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110436, f"Demon Titanite - 2x Demon Titanite Drop from Titanite Demon near Shortcut", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110437, f"Twinkling Titanite - Drop from Twinkling Titanite near Titanite Demon", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110438, f"Demon Ruins Shortcut opened", f"Firebomb", DSRLocationCategory.DOOR),
    DSRLocationData(11110439, f"Red Titanite Chunk - Inside Chaos Eater Pit", f"Firebomb", DSRLocationCategory.ITEM_LOT),
...
"The Catacombs": [
    ...
    DSRLocationData(11110449, f"Catacombs Door 1 opened", f"Firebomb", DSRLocationCategory.DOOR),
    ...
    DSRLocationData(11110459, f"Catacombs Door 2 opened", f"Firebomb", DSRLocationCategory.DOOR),
    ...
    DSRLocationData(11110467, f"White Titanite Chunk - Drop from Axe-wielding Black Knight", f"Firebomb", DSRLocationCategory.DOOR),
...
"Royal Wood": [            
    ...
    DSRLocationData(11110513, f"Twinkling Titanite - Drop from Crystal Lizard past Stone Guardian", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110509, f"Guardian Helmet", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110510, f"Gough's Great Arrow", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110511, f"Guardian Armor", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110512, f"Soul of a Proud Knight - Corpse in Tunnel", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110513, f"Twinkling Titanite - Drop from Crystal Lizard on Right Side", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110514, f"Gold Coin - Down the Slope", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110515, f"Artorias the Abysswalker Defeated", f"Firebomb", DSRLocationCategory.BOSS),
    DSRLocationData(11110516, f"Soul of Artorias", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110517, f"Soul of a Brave Warrior - Outside of Tower", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110518, f"Twinkling Titanite - Drop from Crystal Lizard on Small Platform", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],                        
"Royal Wood - After Hawkeye Gough": [
    DSRLocationData(11110519, f"Black Dragon Kalameet Defeated", f"Firebomb", DSRLocationCategory.BOSS),
    DSRLocationData(11110520, f"Calamity Ring", f"Firebomb", DSRLocationCategory.ITEM_LOT),
],
"Oolacile Township": [    
    DSRLocationData(11110521, f"Oolacile - Township lit", f"Firebomb", DSRLocationCategory.BONFIRE),
    DSRLocationData(11110522, f"Soul of a Hero - Behind left Stairs", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110523, f"Large Soul of a Proud Knight - Roof", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110524, f"Soul of a Brave Warrior - Room with Oolacile Sorceress", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110525, f"Silver Pendant", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110526, f"Sorcery: Dark Orb", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110527, f"I'm Sorry Carving", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110528, f"Soul of a Brave Warrior - Wooden Platform", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110529, f"Very Good! Carving", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110530, f"Rubbish - Outside of Door", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110531, f"Soul of a Hero - Before Doorway", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110532, f"Red Titanite Chunk - In Chest behind Illusory Wall", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110533, f"Crest Key", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110534, f"Sorcery: Dark Fog", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110535, f"Twin Humanities - Drop onto Roof", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110536, f"Soul of a Brave Warrior - Corpse in left Corner", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110537, f"Oolacile - Township Dungeon lit", f"Firebomb", DSRLocationCategory.BONFIRE),
],                        
"Oolacile Township - After Crest Key": [
    DSRLocationData(11110538, f"Oolacile Crest Key Door opened", f"Firebomb", DSRLocationCategory.DOOR),
],
"Chasm of the Abyss": [   
    DSRLocationData(11110539, f"Twinkling Titanite - Drop from Crystal Lizard near Entrance", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110540, f"Sorcery: Dark Bead", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110541, f"Cleansing Greatshield", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110542, f"Humanity - Corpse after Prism Stone", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110543, f"Pyromancy: Black Flame", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110544, f"Help Me! Carving", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110545, f"Twin Humanities - Under Pillar", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110546, f"White Titanite Slab - On Ledge", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110547, f"Soul of a Hero - Left Ledge", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110548, f"Manus, Father of the Abyss Defeated", f"Firebomb", DSRLocationCategory.BOSS),
    DSRLocationData(11110549, f"Soul of Manus", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    DSRLocationData(11110550, f"Chasm of the Abyss lit", f"Firebomb", DSRLocationCategory.BONFIRE),
],
# "Bosses": [
