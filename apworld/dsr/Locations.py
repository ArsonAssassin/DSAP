...
"Upper Undead Burg": [
    ...
    DSRLocationData(11110568, f"Soul of a Lost Undead Upper Undead Burg 2", f"Firebomb", DSRLocationCategory.ITEM_LOT),
    ...
    DSRLocationData(11110053, f"Tauros Demon Defeated", f"Tauros Demon Defeated", DSRLocationCategory.BOSS),
