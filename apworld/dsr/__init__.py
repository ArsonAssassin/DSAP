...
class DSRWorld(World):
    ...
    def set_rules(self) -> None:           
        ...
        set_rule(self.multiworld.get_entrance("Upper Undead Burg -> Lower Undead Burg", self.player), lambda state: state.has("Basement Key", self.player))
        ...
        set_rule(self.multiworld.get_entrance("Upper Undead Burg -> Undead Parish", self.player), lambda state: (state.has("Tauros Demon Defeated", self.player) or state.has("Master Key", self.player) or state.has("Key to New Londo Ruins", self.player))
        ...
        set_rule(self.multiworld.get_entrance("Northern Undead Asylum - Second Visit Snuggly Trades -> Northern Undead Asylum - Second Visit Behind F2 West Door", self.player), lambda state: state.has("Undead Asylum F2 West Key", self.player))
        ...
        set_rule(self.multiworld.get_entrance("Upper New Londo Ruins -> Door between Upper New Londo and Valley of the Drakes", self.player), lambda state: state.has("Key to New Londo Ruins", self.player))
        set_rule(self.multiworld.get_entrance("Valley of the Drakes -> Door between Upper New Londo and Valley of the Drakes", self.player), lambda state: state.has("Key to New Londo Ruins", self.player))
        ...
        set_rule(self.multiworld.get_entrance("Upper New Londo Ruins -> Lower New Londo Ruins", self.player), lambda state: state.has("Key to the Seal", self.player) and state.has("Ornstein and Smough Defeated", self.player))
        set_rule(self.multiworld.get_entrance("Lower New Londo Ruins -> Valley of the Drakes", self.player), lambda state: state.has("Key to the Seal", self.player))
        ...
        set_rule(self.multiworld.get_entrance("Depths -> Blighttown", self.player), lambda state: state.has("Blighttown Key", self.player))
        ...
        set_rule(self.multiworld.get_entrance("The Duke's Archives -> The Duke's Archives - Getting out of Cell", self.player), lambda state: state.has("Archive Tower Cell Key", self.player))
        ...
        set_rule(self.multiworld.get_entrance("Oolacile Township -> Royal Wood - After Hawkeye Gough", self.player), lambda state: state.has("Crest Key", self.player))
