...
If you want a shorter DSR randomizer experience, you can exclude certain regions
...
However, you can set the `Excluded Location Behavior` option to `do_not_randomize` in order to have them not be impacted by AP randomization at all.
